...
Rem Last update date: 17-Dec-24 (??? AM BRT)
...
'$Dynamic
$Resize:On
Icon = _LoadImage("assets/Vantiro-1.1v01b/vantirologo.png")
_Icon Icon, Icon
_Title "Vantiro"
...
Config.Hud_SmoothingY = 5
Config.Hud_SmoothingX = 5
Config.Hud_Size = 32
Config.Player_MaxSpeed = 70
Config.Player_Accel = 3
Config.Player_Size = 25
Config.Player_MaxHealth = 101
Config.Player_HealthPerBlood = 0.11
Config.Player_DamageMultiplier = 1
...
PlayerSprite(1) = _LoadImage("assets/Vantiro-1.1v01b/player/player1.png")
PlayerHand(1) = _LoadImage("assets/Vantiro-1.1v01b/player/hand1.png")
PlayerSprite(2) = _LoadImage("assets/Vantiro-1.1v01b/player/player2.png")
PlayerHand(2) = _LoadImage("assets/Vantiro-1.1v01b/player/hand1.png")
PlayerSprite(3) = _LoadImage("assets/Vantiro-1.1v01b/player/player3.png")
PlayerHand(3) = _LoadImage("assets/Vantiro-1.1v01b/player/hand3.png")
PlayerSprite(4) = _LoadImage("assets/Vantiro-1.1v01b/player/player4.png")
PlayerHand(4) = _LoadImage("assets/Vantiro-1.1v01b/player/hand4.png")
BloodDrop = _LoadImage("assets/Vantiro-1.1v01b/Blooddrop.png")
Dim Shared PlayerDamage
Dim Shared PlayerDeath
PlayerDamage = _SndOpen("assets/Vantiro-1.1v01b/player/sounds/au.wav")
PlayerDeath = _SndOpen("assets/Vantiro-1.1v01b/player/sounds/ua.wav")
FlameThrowerSound = _SndOpen("assets/Vantiro-1.1v01b/sounds/interior_fire01_stereo.wav")

Dim Shared ZombieWalk(4)
ZombieWalk(1) = _SndOpen("assets/Vantiro-1.1v01b/mobs/sounds/headless_1.wav")
ZombieWalk(2) = _SndOpen("assets/Vantiro-1.1v01b/mobs/sounds/headless_2.wav")
ZombieWalk(3) = _SndOpen("assets/Vantiro-1.1v01b/mobs/sounds/headless_3.wav")
ZombieWalk(4) = _SndOpen("assets/Vantiro-1.1v01b/mobs/sounds/headless_4.wav")

Dim Shared ZombieShot(16)
ZombieShot(1) = _SndOpen("assets/Vantiro-1.1v01b/mobs/sounds/shot/been_shot_01.wav")
ZombieShot(2) = _SndOpen("assets/Vantiro-1.1v01b/mobs/sounds/shot/been_shot_02.wav")
ZombieShot(3) = _SndOpen("assets/Vantiro-1.1v01b/mobs/sounds/shot/been_shot_03.wav")
ZombieShot(4) = _SndOpen("assets/Vantiro-1.1v01b/mobs/sounds/shot/been_shot_04.wav")
ZombieShot(5) = _SndOpen("assets/Vantiro-1.1v01b/mobs/sounds/shot/been_shot_05.wav")
ZombieShot(6) = _SndOpen("assets/Vantiro-1.1v01b/mobs/sounds/shot/been_shot_06.wav")
ZombieShot(7) = _SndOpen("assets/Vantiro-1.1v01b/mobs/sounds/shot/been_shot_07.wav")
ZombieShot(8) = _SndOpen("assets/Vantiro-1.1v01b/mobs/sounds/shot/been_shot_08.wav")
ZombieShot(9) = _SndOpen("assets/Vantiro-1.1v01b/mobs/sounds/shot/been_shot_09.wav")
ZombieShot(10) = _SndOpen("assets/Vantiro-1.1v01b/mobs/sounds/shot/been_shot_10.wav")
ZombieShot(11) = _SndOpen("assets/Vantiro-1.1v01b/mobs/sounds/shot/been_shot_11.wav")
ZombieShot(12) = _SndOpen("assets/Vantiro-1.1v01b/mobs/sounds/shot/been_shot_12.wav")
ZombieShot(13) = _SndOpen("assets/Vantiro-1.1v01b/mobs/sounds/shot/been_shot_13.wav")
ZombieShot(14) = _SndOpen("assets/Vantiro-1.1v01b/mobs/sounds/shot/been_shot_14.wav")
ZombieShot(15) = _SndOpen("assets/Vantiro-1.1v01b/mobs/sounds/shot/been_shot_15.wav")
ZombieShot(16) = _SndOpen("assets/Vantiro-1.1v01b/mobs/sounds/shot/been_shot_16.wav")
...
End Type
VantiroTitulo = _LoadImage("assets/Vantiro-1.1v01b/Vantiro.png")
Background1 = _LoadImage("assets/Vantiro-1.1v01b/Background.png")
...
Tileset = _LoadImage("assets/Vantiro-1.1v01b/tileset.png")


E_KeyIcon = _LoadImage("assets/Vantiro-1.1v01b/items/ekeyicon.png")

Guns_Pistol = _LoadImage("assets/Vantiro-1.1v01b/items/pistol.png")
Guns_Shotgun = _LoadImage("assets/Vantiro-1.1v01b/items/shotgun.png")
Guns_SMG = _LoadImage("assets/Vantiro-1.1v01b/items/smg.png")
Guns_Flame = _LoadImage("assets/Vantiro-1.1v01b/items/flamethrower.png")
Guns_Grenade = _LoadImage("assets/Vantiro-1.1v01b/items/grenade.png")
HudSelected = _LoadImage("assets/Vantiro-1.1v01b/Selected.png")
HudNotSelected = _LoadImage("assets/Vantiro-1.1v01b/NotSelected.png")
HudNoAmmo = _LoadImage("assets/Vantiro-1.1v01b/NoAmmo.png")

Zombie = _LoadImage("assets/Vantiro-1.1v01b/mobs/zombie.png")
ZombieRunner = _LoadImage("assets/Vantiro-1.1v01b/mobs/fastzombie.png")
ZombieSlower = _LoadImage("assets/Vantiro-1.1v01b/mobs/slowzombie.png")
ZombieBomber = _LoadImage("assets/Vantiro-1.1v01b/mobs/bomberzombie.png")
ZombieBiohazard = _LoadImage("assets/Vantiro-1.1v01b/mobs/zombie.png") ' GIVE ME IMAGE
ZombieBrute = _LoadImage("assets/Vantiro-1.1v01b/mobs/zombie.png") 'GIVE ME IMAGE
ZombieFire = _LoadImage("assets/Vantiro-1.1v01b/mobs/firezombie.png")

ShellShotgunAmmo = _LoadImage("assets/Vantiro-1.1v01b/items/shotgunammo.png")
PistolShellAmmo = _LoadImage("assets/Vantiro-1.1v01b/items/pistolammo.png")
GasCanAmmo = _LoadImage("assets/Vantiro-1.1v01b/items/gascan.png")


Dim Shared WallShot
WallShot = _LoadImage("assets/Vantiro-1.1v01b/items/wallshot.png")
GlassShard = _LoadImage("assets/Vantiro-1.1v01b/items/glassshard.png")
Dim Shared Bloodsplat
BloodsplatGreen = _LoadImage("assets/Vantiro-1.1v01b/items/bloodsplatgreen.png")
BloodsplatRed = _LoadImage("assets/Vantiro-1.1v01b/items/bloodsplatred.png")
Gib_Skull = _LoadImage("assets/Vantiro-1.1v01b/items/skull.png")
Gib_Bone = _LoadImage("assets/Vantiro-1.1v01b/items/bone.png")
Dim Shared Bloodonground
Bloodonground = _LoadImage("assets/Vantiro-1.1v01b/items/bloodonground.png")
Guns_Sound_PistolShot = _SndOpen("assets/Vantiro-1.1v01b/sounds/pistolshot.wav")
Guns_Sound_ShotgunShot = _SndOpen("assets/Vantiro-1.1v01b/sounds/shotgunshot.wav")

Dim Shared FireParticles(3)
FireParticle = _LoadImage("assets/Vantiro-1.1v01b/items/fire1.png")
FireParticles(1) = _LoadImage("assets/Vantiro-1.1v01b/items/fire1.png")
FireParticles(2) = _LoadImage("assets/Vantiro-1.1v01b/items/fire2.png")
FireParticles(3) = _LoadImage("assets/Vantiro-1.1v01b/items/fire3.png")

Dim SMGSounds(3)
SMGSounds(1) = _SndOpen("assets/Vantiro-1.1v01b/sounds/hks1.wav")
SMGSounds(2) = _SndOpen("assets/Vantiro-1.1v01b/sounds/hks2.wav")
SMGSounds(3) = _SndOpen("assets/Vantiro-1.1v01b/sounds/hks3.wav")

Dim ShellSounds(3)
ShellSounds(1) = _SndOpen("assets/Vantiro-1.1v01b/sounds/sshell1.wav")
ShellSounds(2) = _SndOpen("assets/Vantiro-1.1v01b/sounds/sshell2.wav")
ShellSounds(3) = _SndOpen("assets/Vantiro-1.1v01b/sounds/sshell3.wav")
Dim PistolShellSounds(3)
PistolShellSounds(1) = _SndOpen("assets/Vantiro-1.1v01b/sounds/pl_shell1.wav")
PistolShellSounds(2) = _SndOpen("assets/Vantiro-1.1v01b/sounds/pl_shell2.wav")
PistolShellSounds(3) = _SndOpen("assets/Vantiro-1.1v01b/sounds/pl_shell3.wav")

Dim BloodSounds(6)
BloodSounds(1) = _SndOpen("assets/Vantiro-1.1v01b/sounds/flesh1.wav")
BloodSounds(2) = _SndOpen("assets/Vantiro-1.1v01b/sounds/flesh2.wav")
BloodSounds(3) = _SndOpen("assets/Vantiro-1.1v01b/sounds/flesh3.wav")
BloodSounds(4) = _SndOpen("assets/Vantiro-1.1v01b/sounds/flesh5.wav")
BloodSounds(5) = _SndOpen("assets/Vantiro-1.1v01b/sounds/flesh6.wav")
BloodSounds(6) = _SndOpen("assets/Vantiro-1.1v01b/sounds/flesh7.wav")
Dim Shared GlassShadder(3)
GlassShadder(1) = _SndOpen("assets/Vantiro-1.1v01b/sounds/bustglass1.wav")
GlassShadder(2) = _SndOpen("assets/Vantiro-1.1v01b/sounds/bustglass2.wav")
GlassShadder(3) = _SndOpen("assets/Vantiro-1.1v01b/sounds/bustglass3.wav")
Dim GlassSound(4)
GlassSound(1) = _SndOpen("assets/Vantiro-1.1v01b/sounds/glass1.wav")
GlassSound(2) = _SndOpen("assets/Vantiro-1.1v01b/sounds/glass2.wav")
GlassSound(3) = _SndOpen("assets/Vantiro-1.1v01b/sounds/glass3.wav")
GlassSound(4) = _SndOpen("assets/Vantiro-1.1v01b/sounds/glass4.wav")

HudImageHealth = _NewImage(128, 128, 32)
Hud_Health_Icon = _LoadImage("assets/Vantiro-1.1v01b/BloodIcon.png")
Hud_Health_Fluid = _LoadImage("assets/Vantiro-1.1v01b/BloodHealth.png")

SND_Explosion = _SndOpen("assets/Vantiro-1.1v01b/sounds/explode.mp3")
Particle_Shotgun_Shell = _LoadImage("assets/Vantiro-1.1v01b/items/shotgunshell.png")
Particle_Pistol_Shell = _LoadImage("assets/Vantiro-1.1v01b/items/pistolshell.png")
Particle_Smoke = _LoadImage("assets/Vantiro-1.1v01b/items/smoke.png")
Particle_Explosion = _LoadImage("assets/Vantiro-1.1v01b/items/explosion.png")
...
For i = 1 To 5 'HudWeaponMax ' 6
    ...
    Hud(i).xm = Hud(i).xm / 1.1
    Hud(i).ym = Hud(i).ym / 1.1

    If i = SelectedHudID Then Line (Hud(i).x1, Hud(i).y1)-(Hud(i).x2, Hud(i).y2), _RGB32(255, 255, 255), BF: _MapTriangle (0, 0)-(16, 32)-(32, 0), HudSelected To(Hud(i).x1, Hud(i).y2)-(Hud(i).x, _Height)-(Hud(i).x2, Hud(i).y2)
    If i <> SelectedHudID Then Line (Hud(i).x1, Hud(i).y1)-(Hud(i).x2, Hud(i).y2), _RGB32(128, 128, 128), BF: _MapTriangle (0, 0)-(16, 32)-(32, 0), HudNotSelected To(Hud(i).x1, Hud(i).y2)-(Hud(i).x, _Height)-(Hud(i).x2, Hud(i).y2)
...
If DayAmount < 20 And Tile(Fix(Player.x / Map.TileSize), Fix(Player.y / Map.TileSize), 1).ID = 66 Then PlayerIsOnFire = 5
...
For i = 1 To FireMax
    If Fire(i).visible > 0 Then
        ...
        If Fire(i).txt = 0 And FireTick = 0 Then
            ...
            Next
        End If
        If Int(Rnd * 8) = 3 Then Fire(i).visible = Fire(i).visible - 1
...
_Dest MainScreen
If Not _FileExists("assets/Vantiro-1.1v01b/menu/" + RTrim$(LTrim$(ToLoad$)) + ".bhmenu") Then
    Beep
    FileMissing$ = ToLoad$
    FileMissingtype$ = "Menu file"
    ToLoad$ = "warningfilemissing"
End If
Open ("assets/Vantiro-1.1v01b/menu/" + RTrim$(LTrim$(ToLoad$)) + ".bhmenu") For Input As #1
Input #1, lasti
For i = 1 To lasti
...
Function LoadMapSettings (MapName As String)
    LoadMapSettings = 0
    Open ("assets/Vantiro-1.1v01b/maps/" + MapName + ".map") For Input As #1
