...
'$Dynamic
$Resize:On
Icon = _LoadImage("assets/Vantiro-1.1v05b/vantirologo.png", 32)
_Title "Vantiro"
...
Dim line$
If _FileExists("assets/Vantiro-1.1v05b/config.ini") Then
    LoadConfigs
Else
    Beep
    Print "Error: (assets/Vantiro-1.1v05b/config.ini) not found, generating file."
    _Display
    _Delay 2
    SaveConfig
End If
...
PlayerSprite(1) = _LoadImage("assets/Vantiro-1.1v05b/player/player1.png", 33)
PlayerHand(1) = _LoadImage("assets/Vantiro-1.1v05b/player/hand1.png", 33)
PlayerSprite(2) = _LoadImage("assets/Vantiro-1.1v05b/player/player2.png", 33)
PlayerHand(2) = _LoadImage("assets/Vantiro-1.1v05b/player/hand1.png", 33)
PlayerSprite(3) = _LoadImage("assets/Vantiro-1.1v05b/player/player3.png", 33)
PlayerHand(3) = _LoadImage("assets/Vantiro-1.1v05b/player/hand3.png", 33)
PlayerSprite(4) = _LoadImage("assets/Vantiro-1.1v05b/player/player4.png", 33)
PlayerHand(4) = _LoadImage("assets/Vantiro-1.1v05b/player/hand4.png", 33)
BloodDrop = _LoadImage("assets/Vantiro-1.1v05b/Blooddrop.png", 32)
Dim Shared PlayerDamage
Dim Shared PlayerDeath
PlayerDamage = _SndOpen("assets/Vantiro-1.1v05b/player/sounds/au.wav")
PlayerDeath = _SndOpen("assets/Vantiro-1.1v05b/player/sounds/ua.wav")
FlameThrowerSound = _SndOpen("assets/Vantiro-1.1v05b/sounds/interior_fire01_stereo.wav")

Dim Shared ZombieWalk(4)
ZombieWalk(1) = _SndOpen("assets/Vantiro-1.1v05b/mobs/sounds/headless_1.wav")
ZombieWalk(2) = _SndOpen("assets/Vantiro-1.1v05b/mobs/sounds/headless_2.wav")
ZombieWalk(3) = _SndOpen("assets/Vantiro-1.1v05b/mobs/sounds/headless_3.wav")
ZombieWalk(4) = _SndOpen("assets/Vantiro-1.1v05b/mobs/sounds/headless_4.wav")

Dim Shared ZombieShot(16)
ZombieShot(1) = _SndOpen("assets/Vantiro-1.1v05b/mobs/sounds/shot/been_shot_01.wav")
ZombieShot(2) = _SndOpen("assets/Vantiro-1.1v05b/mobs/sounds/shot/been_shot_02.wav")
ZombieShot(3) = _SndOpen("assets/Vantiro-1.1v05b/mobs/sounds/shot/been_shot_03.wav")
ZombieShot(4) = _SndOpen("assets/Vantiro-1.1v05b/mobs/sounds/shot/been_shot_04.wav")
ZombieShot(5) = _SndOpen("assets/Vantiro-1.1v05b/mobs/sounds/shot/been_shot_05.wav")
ZombieShot(6) = _SndOpen("assets/Vantiro-1.1v05b/mobs/sounds/shot/been_shot_06.wav")
ZombieShot(7) = _SndOpen("assets/Vantiro-1.1v05b/mobs/sounds/shot/been_shot_07.wav")
ZombieShot(8) = _SndOpen("assets/Vantiro-1.1v05b/mobs/sounds/shot/been_shot_08.wav")
ZombieShot(9) = _SndOpen("assets/Vantiro-1.1v05b/mobs/sounds/shot/been_shot_09.wav")
ZombieShot(10) = _SndOpen("assets/Vantiro-1.1v05b/mobs/sounds/shot/been_shot_10.wav")
ZombieShot(11) = _SndOpen("assets/Vantiro-1.1v05b/mobs/sounds/shot/been_shot_11.wav")
ZombieShot(12) = _SndOpen("assets/Vantiro-1.1v05b/mobs/sounds/shot/been_shot_12.wav")
ZombieShot(13) = _SndOpen("assets/Vantiro-1.1v05b/mobs/sounds/shot/been_shot_13.wav")
ZombieShot(14) = _SndOpen("assets/Vantiro-1.1v05b/mobs/sounds/shot/been_shot_14.wav")
ZombieShot(15) = _SndOpen("assets/Vantiro-1.1v05b/mobs/sounds/shot/been_shot_15.wav")
ZombieShot(16) = _SndOpen("assets/Vantiro-1.1v05b/mobs/sounds/shot/been_shot_16.wav")
...
missing = _LoadImage("assets/Vantiro-1.1v05b/missing.png", 33)
VantiroTitulo = _LoadImage("assets/Vantiro-1.1v05b/Vantiro.png", 33)
Background1 = _LoadImage("assets/Vantiro-1.1v05b/Background.png", 33)
HudWeaponMax = 16
...
Tileset = _LoadImage("assets/Vantiro-1.1v05b/tileset.png", 33)


E_KeyIcon = _LoadImage("assets/Vantiro-1.1v05b/items/ekeyicon.png", 33)

Guns_Hammer = _LoadImage("assets/Vantiro-1.1v05b/items/hammer.png", 33)
Guns_Pistol = _LoadImage("assets/Vantiro-1.1v05b/items/pistol.png", 33)
Guns_Shotgun = _LoadImage("assets/Vantiro-1.1v05b/items/shotgun.png", 33)
Guns_SMG = _LoadImage("assets/Vantiro-1.1v05b/items/smg.png", 33)
Guns_Flame = _LoadImage("assets/Vantiro-1.1v05b/items/flamethrower.png", 33)
Guns_Grenade = _LoadImage("assets/Vantiro-1.1v05b/items/grenade.png", 33)
HudSelected = _LoadImage("assets/Vantiro-1.1v05b/Selected.png", 33)
HudNotSelected = _LoadImage("assets/Vantiro-1.1v05b/NotSelected.png", 33)
HudNoAmmo = _LoadImage("assets/Vantiro-1.1v05b/NoAmmo.png", 33)

Zombie = _LoadImage("assets/Vantiro-1.1v05b/mobs/zombie.png", 33)
ZombieRunner = _LoadImage("assets/Vantiro-1.1v05b/mobs/fastzombie.png", 33)
ZombieSlower = _LoadImage("assets/Vantiro-1.1v05b/mobs/slowzombie.png", 33)
ZombieBomber = _LoadImage("assets/Vantiro-1.1v05b/mobs/bomberzombie.png", 33)
ZombieBiohazard = _LoadImage("assets/Vantiro-1.1v05b/mobs/zombie.png", 33) ' GIVE ME IMAGE
ZombieBrute = _LoadImage("assets/Vantiro-1.1v05b/mobs/zombie.png", 33) 'GIVE ME IMAGE
ZombieFire = _LoadImage("assets/Vantiro-1.1v05b/mobs/firezombie.png", 33)
...
ShellShotgunAmmo = _LoadImage("assets/Vantiro-1.1v05b/items/shotgunammo.png", 33)
PistolShellAmmo = _LoadImage("assets/Vantiro-1.1v05b/items/pistolammo.png", 33)
GasCanAmmo = _LoadImage("assets/Vantiro-1.1v05b/items/gascan.png", 33)


Dim Shared WallShot
WallShot = _LoadImage("assets/Vantiro-1.1v05b/items/wallshot.png", 33)
GlassShard = _LoadImage("assets/Vantiro-1.1v05b/items/glassshard.png", 33)
Dim Shared Bloodsplat
BloodsplatGreen = _LoadImage("assets/Vantiro-1.1v05b/items/bloodsplatgreen.png", 33)
BloodsplatRed = _LoadImage("assets/Vantiro-1.1v05b/items/bloodsplatred.png", 33)
Gib_Skull = _LoadImage("assets/Vantiro-1.1v05b/items/skull.png", 33)
Gib_Bone = _LoadImage("assets/Vantiro-1.1v05b/items/bone.png", 33)
Dim Shared Bloodonground
Bloodonground = _LoadImage("assets/Vantiro-1.1v05b/items/bloodonground.png", 32)
Guns_Sound_PistolShot = _SndOpen("assets/Vantiro-1.1v05b/sounds/pistolshot.wav")
Guns_Sound_ShotgunShot = _SndOpen("assets/Vantiro-1.1v05b/sounds/shotgunshot.wav")

Dim Shared FireParticles(3)
FireParticle = _LoadImage("assets/Vantiro-1.1v05b/items/fire1.png", 33)
FireParticles(1) = _LoadImage("assets/Vantiro-1.1v05b/items/fire1.png", 33)
FireParticles(2) = _LoadImage("assets/Vantiro-1.1v05b/items/fire2.png", 33)
FireParticles(3) = _LoadImage("assets/Vantiro-1.1v05b/items/fire3.png", 33)

Dim SMGSounds(3)
SMGSounds(1) = _SndOpen("assets/Vantiro-1.1v05b/sounds/hks1.wav")
SMGSounds(2) = _SndOpen("assets/Vantiro-1.1v05b/sounds/hks2.wav")
SMGSounds(3) = _SndOpen("assets/Vantiro-1.1v05b/sounds/hks3.wav")

Dim ShellSounds(3)
ShellSounds(1) = _SndOpen("assets/Vantiro-1.1v05b/sounds/sshell1.wav")
ShellSounds(2) = _SndOpen("assets/Vantiro-1.1v05b/sounds/sshell2.wav")
ShellSounds(3) = _SndOpen("assets/Vantiro-1.1v05b/sounds/sshell3.wav")
Dim PistolShellSounds(3)
PistolShellSounds(1) = _SndOpen("assets/Vantiro-1.1v05b/sounds/pl_shell1.wav")
PistolShellSounds(2) = _SndOpen("assets/Vantiro-1.1v05b/sounds/pl_shell2.wav")
PistolShellSounds(3) = _SndOpen("assets/Vantiro-1.1v05b/sounds/pl_shell3.wav")

Dim BloodSounds(6)
BloodSounds(1) = _SndOpen("assets/Vantiro-1.1v05b/sounds/flesh1.wav")
BloodSounds(2) = _SndOpen("assets/Vantiro-1.1v05b/sounds/flesh2.wav")
BloodSounds(3) = _SndOpen("assets/Vantiro-1.1v05b/sounds/flesh3.wav")
BloodSounds(4) = _SndOpen("assets/Vantiro-1.1v05b/sounds/flesh5.wav")
BloodSounds(5) = _SndOpen("assets/Vantiro-1.1v05b/sounds/flesh6.wav")
BloodSounds(6) = _SndOpen("assets/Vantiro-1.1v05b/sounds/flesh7.wav")
Dim Shared GlassShadder(3)
GlassShadder(1) = _SndOpen("assets/Vantiro-1.1v05b/sounds/bustglass1.wav")
GlassShadder(2) = _SndOpen("assets/Vantiro-1.1v05b/sounds/bustglass2.wav")
GlassShadder(3) = _SndOpen("assets/Vantiro-1.1v05b/sounds/bustglass3.wav")
Dim GlassSound(4)
GlassSound(1) = _SndOpen("assets/Vantiro-1.1v05b/sounds/glass1.wav")
GlassSound(2) = _SndOpen("assets/Vantiro-1.1v05b/sounds/glass2.wav")
GlassSound(3) = _SndOpen("assets/Vantiro-1.1v05b/sounds/glass3.wav")
GlassSound(4) = _SndOpen("assets/Vantiro-1.1v05b/sounds/glass4.wav")

HudImageHealth = _NewImage(128, 128, 32)
Hud_Health_Icon = _LoadImage("assets/Vantiro-1.1v05b/BloodIcon.png", 32)
Hud_Health_Fluid = _LoadImage("assets/Vantiro-1.1v05b/BloodHealth.png", 32)

SND_Explosion = _SndOpen("assets/Vantiro-1.1v05b/sounds/explode.mp3")
Particle_Shotgun_Shell = _LoadImage("assets/Vantiro-1.1v05b/items/shotgunshell.png", 33)
Particle_Pistol_Shell = _LoadImage("assets/Vantiro-1.1v05b/items/pistolshell.png", 33)
Particle_Smoke = _LoadImage("assets/Vantiro-1.1v05b/items/smoke.png", 33)
Particle_Explosion = _LoadImage("assets/Vantiro-1.1v05b/items/explosion.png", 33)
...
For g = 1 To 6
    ...
    Graph(g).y1 = (g * 50) - 50
    Graph(g).y2 = (g * 50)
    Graph(g).xsize = Int(Graph(g).x2 - Graph(g).x1)
    Graph(g).ysize = Int(Graph(g).y2 - Graph(g).y1)
    Graph(g).x = Int((Graph(g).x1 + Graph(g).x2) / 2)
    Graph(g).y = Int((Graph(g).y1 + Graph(g).y2) / 2)
    Graph(g).xb = Graph(g).x
    Graph(g).yb = Graph(g).y
    Graph(g).value = 0
Next
Graph(1).myname = "Map Rend. - "
Graph(2).myname = "Zombie AI - "
Graph(3).myname = "Zombie Rend. - "
Graph(4).myname = "Fire Logic - "
Graph(5).myname = "Particle Logic - "
Graph(6).myname = "Graph Rend. - "
Dim ProceedCheck As Double
Dim MapFPS As Double
Dim ZombieAIFPS As Double
Dim ZombieRenderFPS As Double
Dim FireFPS As Double
Dim GraphFPS As Double
For i = 1 To 6
...
For X = rendcamerax1 To rendcamerax2 'Map.MaxWidth
    For y = rendcameray1 To rendcameray2 'Map.MaxHeight
        XCalc = WTS(X, CameraX)
        YCalc = WTS(y, CameraY)
        If Tile(X, y, 1).ID <> 0 Then _PutImage (XCalc, YCalc)-(XCalc + Map.TileSize, YCalc + Map.TileSize), Tileset, 0, (Tile(X, y, 1).x1t, Tile(X, y, 1).y1t)-(Tile(X, y, 1).x2t, Tile(X, y, 1).y2t)
        If Tile(X, y, 2).ID <> 0 Then _PutImage (XCalc, YCalc)-(XCalc + Map.TileSize, YCalc + Map.TileSize), Tileset, 0, (Tile(X, y, 2).x1t, Tile(X, y, 2).y1t)-(Tile(X, y, 2).x2t, Tile(X, y, 2).y2t)
    Next
Next
...
LoadAllMaps:
Dim findfile As String: findfile = _Files$("assets/Vantiro-1.1v05b/maps/*.map")
i = 0
ImagesFound = 0
Do While Len(findfile) > 0
    ...
    If _FileExists("assets/Vantiro-1.1v05b/maps/" + ImageAlternative$) Then
        ...
        MapLoaderImage(ImagesFound) = _LoadImage("assets/Vantiro-1.1v05b/maps/" + ImageAlternative$)
...
_Dest MainScreen
If Not _FileExists("assets/Vantiro-1.1v05b/menu/" + RTrim$(LTrim$(ToLoad$)) + ".bhmenu") Then
    Beep
    FileMissing$ = ToLoad$
    FileMissingtype$ = "Menu file"
    ToLoad$ = "warningfilemissing"
End If
Open ("assets/Vantiro-1.1v05b/menu/" + RTrim$(LTrim$(ToLoad$)) + ".bhmenu") For Input As #1
Input #1, lasti
For i = 1 To lasti
...
Function LoadMapSettings (MapName As String)
    LoadMapSettings = 0
    Open ("assets/Vantiro-1.1v05b/maps/" + MapName + ".map") For Input As #1
...
Sub LoadConfigs
    Dim trash$
    Open ("assets/Vantiro-1.1v05b/config.ini") For Input As #4
    Input #4, trash$
...
Sub SaveConfig
    Open ("assets/Vantiro-1.1v05b/config.ini") For Output As #4
