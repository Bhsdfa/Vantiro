...
'$Dynamic
$Resize:On
Icon = _LoadImage("assets/pc/vantirologo.png", 32)
_Icon Icon, Icon
_Title "Vantiro"
...
Dim line$
If _FileExists("assets/pc/config.ini") Then
    LoadConfigs
Else
    Beep
    Print "Error: (assets/pc/config.ini) not found, generating file."
    _Display
    _Delay 2
    SaveConfig
End If
...
PlayerSprite(1) = _LoadImage("assets/pc/player/player1.png", 33)
PlayerHand(1) = _LoadImage("assets/pc/player/hand1.png", 33)
PlayerSprite(2) = _LoadImage("assets/pc/player/player2.png", 33)
PlayerHand(2) = _LoadImage("assets/pc/player/hand1.png", 33)
PlayerSprite(3) = _LoadImage("assets/pc/player/player3.png", 33)
PlayerHand(3) = _LoadImage("assets/pc/player/hand3.png", 33)
PlayerSprite(4) = _LoadImage("assets/pc/player/player4.png", 33)
PlayerHand(4) = _LoadImage("assets/pc/player/hand4.png", 33)
BloodDrop = _LoadImage("assets/pc/Blooddrop.png", 32)
...
missing = _LoadImage("assets/pc/missing.png", 33)
VantiroTitulo = _LoadImage("assets/pc/Vantiro.png", 33)
Background1 = _LoadImage("assets/pc/Background.png", 33)
HudWeaponMax = 16
...
Tileset = _LoadImage("assets/pc/" + _Trim$(Map.tileset) + ".png", 33)
TilesetSoft = _LoadImage("assets/pc/" + _Trim$(Map.tileset) + ".png", 32)


E_KeyIcon = _LoadImage("assets/pc/items/ekeyicon.png", 33)

Guns_Hammer = _LoadImage("assets/pc/items/hammer.png", 33)
Guns_Pistol = _LoadImage("assets/pc/items/pistol.png", 33)
Guns_Shotgun = _LoadImage("assets/pc/items/shotgun.png", 33)
Guns_SMG = _LoadImage("assets/pc/items/smg.png", 33)
Guns_Flame = _LoadImage("assets/pc/items/flamethrower.png", 33)
Guns_Grenade = _LoadImage("assets/pc/items/grenade.png", 33)
Guns_Chainsaw = CreateImageText(Guns_Chainsaw, "Chainsaw", 25)
HudSelected = _LoadImage("assets/pc/Selected.png", 33)
HudNotSelected = _LoadImage("assets/pc/NotSelected.png", 33)
HudNoAmmo = _LoadImage("assets/pc/NoAmmo.png", 33)

Zombie = _LoadImage("assets/pc/mobs/zombie.png", 33)
ZombieRunner = _LoadImage("assets/pc/mobs/fastzombie.png", 33)
ZombieSlower = _LoadImage("assets/pc/mobs/slowzombie.png", 33)
ZombieBomber = _LoadImage("assets/pc/mobs/bomberzombie.png", 33)
ZombieBiohazard = _LoadImage("assets/pc/mobs/zombie.png", 33) ' GIVE ME IMAGE
ZombieBrute = _LoadImage("assets/pc/mobs/zombie.png", 33) 'GIVE ME IMAGE
ZombieFire = _LoadImage("assets/pc/mobs/firezombie.png", 33)
...
ShellShotgunAmmo = _LoadImage("assets/pc/items/shotgunammo.png", 33)
PistolShellAmmo = _LoadImage("assets/pc/items/pistolammo.png", 33)
GasCanAmmo = _LoadImage("assets/pc/items/gascan.png", 33)


Dim Shared WallShot
WallShot = _LoadImage("assets/pc/items/wallshot.png", 33)
GlassShard = _LoadImage("assets/pc/items/glassshard.png", 33)
Dim Shared Bloodsplat
BloodsplatGreen = _LoadImage("assets/pc/items/bloodsplatgreen.png", 33)
BloodsplatRed = _LoadImage("assets/pc/items/bloodsplatred.png", 33)
Gib_Skull = _LoadImage("assets/pc/items/skull.png", 33)
Gib_Bone = _LoadImage("assets/pc/items/bone.png", 33)
Dim Shared Bloodonground
Bloodonground = _LoadImage("assets/pc/items/bloodonground.png", 32)
...
FireParticle = _LoadImage("assets/pc/items/fire1.png", 33)
FireParticles(1) = _LoadImage("assets/pc/items/fire1.png", 33)
FireParticles(2) = _LoadImage("assets/pc/items/fire2.png", 33)
FireParticles(3) = _LoadImage("assets/pc/items/fire3.png", 33)
...
Hud_Health_Icon = _LoadImage("assets/pc/BloodIcon.png", 32)
Hud_Health_Fluid = _LoadImage("assets/pc/BloodHealth.png", 32)

SND_Explosion = _SndOpen("assets/pc/sounds/explode.mp3")
Particle_Shotgun_Shell = _LoadImage("assets/pc/items/shotgunshell.png", 33)
Particle_Pistol_Shell = _LoadImage("assets/pc/items/pistolshell.png", 33)
Particle_Smoke = _LoadImage("assets/pc/items/smoke.png", 33)
Particle_Explosion = _LoadImage("assets/pc/items/explosion.png", 33)
...
Dim Shared StaticLightMax: StaticLightMax = 40
Dim Shared DynamicLightMax: DynamicLightMax = 40
...
Next
lastwaypoint = 0
Dim Shared numberimage(100)
For i = 0 To 100
    numberimage(i) = CreateImageText(numberimage(i), Str$(i), 60)
Next
    ...
    If Debug = 1 Then
        For i = 1 To WaypointMax
            If Waypoint(i).exist Then
                If Waypoint(i).playerdist < 100 And Waypoint(i).playerdist >= 0 Then _PutImage (ETSX(Waypoint(i).x - Map.TileSize / 2.5), ETSY(Waypoint(i).y - Map.TileSize / 2.5)), numberimage(Waypoint(i).playerdist)
                Line (ETSX(Waypoint(i).x - Map.TileSize / 2.5), ETSY(Waypoint(i).y - Map.TileSize / 2.5))-(ETSX(Waypoint(i).x + Map.TileSize / 2.5), ETSY(Waypoint(i).y + Map.TileSize / 2.5)), _RGBA32(255, 255, 255, 128), BF
...
If _KeyDown(16384) And delay = 0 Then ' " ' " key, saves waypoints.
    delay = 30
    Open ("assets/pc/maps/" + Map$ + ".waypoints") For Output As #3
...
If _KeyDown(16640) And delay = 0 Then ' " ' " key, saves waypoints.
    delay = 30
    Open ("assets/pc/maps/" + Map$ + ".waypoints") For Input As #3
...
For i = 1 To 1
    ...
    If GunDisplay.visible = 1 Then
        ...
        If Player.shooting = 1 Then
            CreateDynamicLight GunDisplay.x + GunSin * 80, GunDisplay.y + GunCos * 80, 250, 4
...
LoadAllMaps:
Dim findfile As String: findfile = _Files$("assets/pc/maps/*.map")
i = 0
ImagesFound = 0
Do While Len(findfile) > 0
    ...
    If _FileExists("assets/pc/maps/" + ImageAlternative$) Then
        ...
        MapLoaderImage(ImagesFound) = _LoadImage("assets/pc/maps/" + ImageAlternative$)
...
Sub LoadConfigs
    Dim trash$
    Open ("assets/pc/config.ini") For Input As #4
    Input #4, version
    Input #4, trash$
...
Sub SaveConfig
    Open ("assets/pc/config.ini") For Output As #4
...
Sub ZombieAIChasePoint (Zombie As Entity)
    ...
    If Distance(Zombie.x, Zombie.y, Waypoint(Zombie.pointfollow).x, Waypoint(Zombie.pointfollow).y) < Map.TileSize * 1.3 Then
        ...
        Zombie.pointtries = 0
        If Waypoint(Zombie.pointfollow).playerdist <> 0 Then
            For o = 1 To 16
                If Waypoint(WaypointJoints(Zombie.pointfollow, o)).playerdist = Waypoint(Zombie.pointfollow).playerdist - 1 Then Zombie.pointfollow = WaypointJoints(Zombie.pointfollow, o): Exit For
            Next
        End If
    End If
...
Sub CalcLightingDynLow (Light As LightSource)
    xmin = Fix(Light.x / Map.TileSize) - 10
    xmax = Fix(Light.x / Map.TileSize) + 10
    ymin = Fix(Light.y / Map.TileSize) - 10
    ymax = Fix(Light.y / Map.TileSize) + 10
...
Sub CalcLightingStatic (Light As LightSource)
    xmin = Fix(Light.x / Map.TileSize) - 20
    xmax = Fix(Light.x / Map.TileSize) + 20
    ymin = Fix(Light.y / Map.TileSize) - 20
    ymax = Fix(Light.y / Map.TileSize) + 20
    If xmin < 0 Then xmin = 0
    If ymin < 0 Then ymin = 0
    If xmin > Map.MaxWidth Then xmax = Map.MaxWidth
    If ymax > Map.MaxWidth Then ymax = Map.MaxHeight
    ...
    For x = xmin To xmax
        For y = ymin To ymax
            ...
            Isview = ShadowView(Light.x - 5, Light.y, (x * Map.TileSize) + (Map.TileSize / 2) + 5, (y * Map.TileSize) + (Map.TileSize / 2), Map.TileSize / 4, 15, 100)
            If Isview <> -1 Then newlight = (newlight - (Isview * 1.5))
...
Sub CreateDynamicLight (x As Double, y As Double, strength As Integer, duration As Integer)
