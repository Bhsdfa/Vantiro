...
'$Dynamic
$Resize:On
Icon = _LoadImage("assets/Vantiro-1.1v/vantirologo.png")
_Icon Icon, Icon
_Title "Vantiro"
...
PlayerSprite(1) = _LoadImage("assets/Vantiro-1.1v/player/player1.png", 33)
PlayerHand(1) = _LoadImage("assets/Vantiro-1.1v/player/hand1.png", 33)

PlayerSprite(2) = _LoadImage("assets/Vantiro-1.1v/player/player2.png", 33)
PlayerHand(2) = _LoadImage("assets/Vantiro-1.1v/player/hand1.png", 33)

PlayerSprite(3) = _LoadImage("assets/Vantiro-1.1v/player/player3.png", 33)
PlayerHand(3) = _LoadImage("assets/Vantiro-1.1v/player/hand3.png", 33)

PlayerSprite(4) = _LoadImage("assets/Vantiro-1.1v/player/player4.png", 33)
PlayerHand(4) = _LoadImage("assets/Vantiro-1.1v/player/hand4.png", 33)

BloodDrop = _LoadImage("assets/Vantiro-1.1v/Blooddrop.png", 33)

Dim Shared PlayerDamage
Dim Shared PlayerDeath
PlayerDamage = _SndOpen("assets/Vantiro-1.1v/player/sounds/au.wav")
PlayerDeath = _SndOpen("assets/Vantiro-1.1v/player/sounds/ua.wav")
FlameThrowerSound = _SndOpen("assets/Vantiro-1.1v/sounds/interior_fire01_stereo.wav")

Dim Shared ZombieWalk(4)
ZombieWalk(1) = _SndOpen("assets/Vantiro-1.1v/mobs/sounds/headless_1.wav")
ZombieWalk(2) = _SndOpen("assets/Vantiro-1.1v/mobs/sounds/headless_2.wav")
ZombieWalk(3) = _SndOpen("assets/Vantiro-1.1v/mobs/sounds/headless_3.wav")
ZombieWalk(4) = _SndOpen("assets/Vantiro-1.1v/mobs/sounds/headless_4.wav")

Dim Shared ZombieShot(16)
ZombieShot(1) = _SndOpen("assets/Vantiro-1.1v/mobs/sounds/shot/been_shot_01.wav")
ZombieShot(2) = _SndOpen("assets/Vantiro-1.1v/mobs/sounds/shot/been_shot_02.wav")
ZombieShot(3) = _SndOpen("assets/Vantiro-1.1v/mobs/sounds/shot/been_shot_03.wav")
ZombieShot(4) = _SndOpen("assets/Vantiro-1.1v/mobs/sounds/shot/been_shot_04.wav")
ZombieShot(5) = _SndOpen("assets/Vantiro-1.1v/mobs/sounds/shot/been_shot_05.wav")
ZombieShot(6) = _SndOpen("assets/Vantiro-1.1v/mobs/sounds/shot/been_shot_06.wav")
ZombieShot(7) = _SndOpen("assets/Vantiro-1.1v/mobs/sounds/shot/been_shot_07.wav")
ZombieShot(8) = _SndOpen("assets/Vantiro-1.1v/mobs/sounds/shot/been_shot_08.wav")
ZombieShot(9) = _SndOpen("assets/Vantiro-1.1v/mobs/sounds/shot/been_shot_09.wav")
ZombieShot(10) = _SndOpen("assets/Vantiro-1.1v/mobs/sounds/shot/been_shot_10.wav")
ZombieShot(11) = _SndOpen("assets/Vantiro-1.1v/mobs/sounds/shot/been_shot_11.wav")
ZombieShot(12) = _SndOpen("assets/Vantiro-1.1v/mobs/sounds/shot/been_shot_12.wav")
ZombieShot(13) = _SndOpen("assets/Vantiro-1.1v/mobs/sounds/shot/been_shot_13.wav")
ZombieShot(14) = _SndOpen("assets/Vantiro-1.1v/mobs/sounds/shot/been_shot_14.wav")
ZombieShot(15) = _SndOpen("assets/Vantiro-1.1v/mobs/sounds/shot/been_shot_15.wav")
ZombieShot(16) = _SndOpen("assets/Vantiro-1.1v/mobs/sounds/shot/been_shot_16.wav")
...
End Type
VantiroTitulo = _LoadImage("assets/Vantiro-1.1v/Vantiro.png", 33)
Background1 = _LoadImage("assets/Vantiro-1.1v/Background.png", 33)
...
TilesetSoft = _LoadImage("assets/Vantiro-1.1v/tileset.png")
Tileset = _LoadImage("assets/Vantiro-1.1v/tileset.png", 33)


E_KeyIcon = _LoadImage("assets/Vantiro-1.1v/items/ekeyicon.png", 33)

Guns_Pistol = _LoadImage("assets/Vantiro-1.1v/items/pistol.png", 33)
Guns_Shotgun = _LoadImage("assets/Vantiro-1.1v/items/shotgun.png", 33)
Guns_SMG = _LoadImage("assets/Vantiro-1.1v/items/smg.png", 33)
Guns_Flame = _LoadImage("assets/Vantiro-1.1v/items/flamethrower.png", 33)
Guns_Grenade = _LoadImage("assets/Vantiro-1.1v/items/grenade.png", 33)
HudSelected = _LoadImage("assets/Vantiro-1.1v/Selected.png", 33)
HudNotSelected = _LoadImage("assets/Vantiro-1.1v/NotSelected.png", 33)
HudNoAmmo = _LoadImage("assets/Vantiro-1.1v/NoAmmo.png", 33)

Zombie = _LoadImage("assets/Vantiro-1.1v/mobs/zombie.png", 33)
ZombieRunner = _LoadImage("assets/Vantiro-1.1v/mobs/fastzombie.png", 33)
ZombieSlower = _LoadImage("assets/Vantiro-1.1v/mobs/slowzombie.png", 33)
ZombieBomber = _LoadImage("assets/Vantiro-1.1v/mobs/bomberzombie.png", 33)
ZombieBiohazard = _LoadImage("assets/Vantiro-1.1v/mobs/zombie.png", 33) ' GIVE ME IMAGE
ZombieBrute = _LoadImage("assets/Vantiro-1.1v/mobs/zombie.png", 33) 'GIVE ME IMAGE
ZombieFire = _LoadImage("assets/Vantiro-1.1v/mobs/firezombie.png", 33)

ShellShotgunAmmo = _LoadImage("assets/Vantiro-1.1v/items/shotgunammo.png", 33)
PistolShellAmmo = _LoadImage("assets/Vantiro-1.1v/items/pistolammo.png", 33)
GasCanAmmo = _LoadImage("assets/Vantiro-1.1v/items/gascan.png", 33)


Dim Shared WallShot
WallShot = _LoadImage("assets/Vantiro-1.1v/items/wallshot.png", 33)
GlassShard = _LoadImage("assets/Vantiro-1.1v/items/glassshard.png", 33)
Dim Shared Bloodsplat
BloodsplatGreen = _LoadImage("assets/Vantiro-1.1v/items/bloodsplatgreen.png", 33)
BloodsplatRed = _LoadImage("assets/Vantiro-1.1v/items/bloodsplatred.png", 33)
Gib_Skull = _LoadImage("assets/Vantiro-1.1v/items/skull.png", 33)
Gib_Bone = _LoadImage("assets/Vantiro-1.1v/items/bone.png", 33)
Dim Shared Bloodonground
Bloodonground = _LoadImage("assets/Vantiro-1.1v/items/bloodonground.png", 33)
Guns_Sound_PistolShot = _SndOpen("assets/Vantiro-1.1v/sounds/pistolshot.wav")
Guns_Sound_ShotgunShot = _SndOpen("assets/Vantiro-1.1v/sounds/shotgunshot.wav")

Dim Shared FireParticles(3)
FireParticle = _LoadImage("assets/Vantiro-1.1v/items/fire1.png", 33)
FireParticles(1) = _LoadImage("assets/Vantiro-1.1v/items/fire1.png", 33)
FireParticles(2) = _LoadImage("assets/Vantiro-1.1v/items/fire2.png", 33)
FireParticles(3) = _LoadImage("assets/Vantiro-1.1v/items/fire3.png", 33)

Dim SMGSounds(3)
SMGSounds(1) = _SndOpen("assets/Vantiro-1.1v/sounds/hks1.wav")
SMGSounds(2) = _SndOpen("assets/Vantiro-1.1v/sounds/hks2.wav")
SMGSounds(3) = _SndOpen("assets/Vantiro-1.1v/sounds/hks3.wav")

Dim ShellSounds(3)
ShellSounds(1) = _SndOpen("assets/Vantiro-1.1v/sounds/sshell1.wav")
ShellSounds(2) = _SndOpen("assets/Vantiro-1.1v/sounds/sshell2.wav")
ShellSounds(3) = _SndOpen("assets/Vantiro-1.1v/sounds/sshell3.wav")
Dim PistolShellSounds(3)
PistolShellSounds(1) = _SndOpen("assets/Vantiro-1.1v/sounds/pl_shell1.wav")
PistolShellSounds(2) = _SndOpen("assets/Vantiro-1.1v/sounds/pl_shell2.wav")
PistolShellSounds(3) = _SndOpen("assets/Vantiro-1.1v/sounds/pl_shell3.wav")

Dim BloodSounds(6)
BloodSounds(1) = _SndOpen("assets/Vantiro-1.1v/sounds/flesh1.wav")
BloodSounds(2) = _SndOpen("assets/Vantiro-1.1v/sounds/flesh2.wav")
BloodSounds(3) = _SndOpen("assets/Vantiro-1.1v/sounds/flesh3.wav")
BloodSounds(4) = _SndOpen("assets/Vantiro-1.1v/sounds/flesh5.wav")
BloodSounds(5) = _SndOpen("assets/Vantiro-1.1v/sounds/flesh6.wav")
BloodSounds(6) = _SndOpen("assets/Vantiro-1.1v/sounds/flesh7.wav")
Dim Shared GlassShadder(3)
GlassShadder(1) = _SndOpen("assets/Vantiro-1.1v/sounds/bustglass1.wav")
GlassShadder(2) = _SndOpen("assets/Vantiro-1.1v/sounds/bustglass2.wav")
GlassShadder(3) = _SndOpen("assets/Vantiro-1.1v/sounds/bustglass3.wav")
Dim GlassSound(4)
GlassSound(1) = _SndOpen("assets/Vantiro-1.1v/sounds/glass1.wav")
GlassSound(2) = _SndOpen("assets/Vantiro-1.1v/sounds/glass2.wav")
GlassSound(3) = _SndOpen("assets/Vantiro-1.1v/sounds/glass3.wav")
GlassSound(4) = _SndOpen("assets/Vantiro-1.1v/sounds/glass4.wav")

HudImageHealth = _NewImage(128, 128, 32)
Hud_Health_Icon = _LoadImage("assets/Vantiro-1.1v/BloodIcon.png")
Hud_Health_Fluid = _LoadImage("assets/Vantiro-1.1v/BloodHealth.png")

SND_Explosion = _SndOpen("assets/Vantiro-1.1v/sounds/explode.mp3")
Particle_Shotgun_Shell = _LoadImage("assets/Vantiro-1.1v/items/shotgunshell.png", 33)
Particle_Pistol_Shell = _LoadImage("assets/Vantiro-1.1v/items/pistolshell.png", 33)
Particle_Smoke = _LoadImage("assets/Vantiro-1.1v/items/smoke.png", 33)
Particle_Explosion = _LoadImage("assets/Vantiro-1.1v/items/explosion.png", 33)
...
Dim Shared LightLevel(128) As Long
...
Do
    ...
    GoSub RenderLayer3
    GoSub TriggerPlayer
    _PutImage (0, 0)-(_Width, _Height), LightLevel(DayAmount)
    GoSub Fire
...
Randomize Timer
If WaveWait = 0 Then
    WaveWait = 600: WaveDisplayY = -thy: Wave = Wave + 1: WaveBudget = (Wave * (Int(Rnd * 4) + 5)) + Int(Rnd * 29)
...
_Dest MainScreen
If Not _FileExists("assets/Vantiro-1.1v/menu/" + RTrim$(LTrim$(ToLoad$)) + ".bhmenu") Then
    Beep
    FileMissing$ = ToLoad$
    FileMissingtype$ = "Menu file"
    ToLoad$ = "warningfilemissing"
End If
Open ("assets/Vantiro-1.1v/menu/" + RTrim$(LTrim$(ToLoad$)) + ".bhmenu") For Input As #1
Input #1, lasti
For i = 1 To lasti
...
Function LoadMapSettings (MapName As String)
    LoadMapSettings = 0
    Open ("assets/Vantiro-1.1v/maps/" + MapName + ".map") For Input As #1
