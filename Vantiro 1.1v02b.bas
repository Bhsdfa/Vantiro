...
Rem Last update date: 19-Dec-24 (1:11 AM BRT)
...
'$Dynamic
$Resize:On
Icon = _LoadImage("assets/Vantiro-1.1v02b/vantirologo.png")
_Icon Icon, Icon
_Title "Vantiro"
...
' Hud settings.
Config.Hud_SmoothingY = 5 ' (Def: 5)
Config.Hud_SmoothingX = 5 ' (Def: 5)
Config.Hud_Size = 32 ' (Def: 32)
Config.Hud_XMYMDivide = 1.1 ' (Def: 1.1)
Config.Hud_SelectedColor = 4294967295 ' (Def: 4294967295)
Config.Hud_UnSelectedColor = 4286611584 ' (Def: 4286611584)
' Player settings.
...
Config.FireMax = 80 ' (Def: 80)
Config.BiohazardFluidMax = 32 ' (Def: 32)

Dim line$
If _FileExists("assets/Vantiro-1.1v02b/config.ini") Then
    LoadConfigs
Else
    Beep
    Print "Error: (assets/Vantiro-1.1v02b/config.ini) not found, generating file."
    _Display
    _Delay 2
    SaveConfig
End If
...
PlayerSprite(1) = _LoadImage("assets/Vantiro-1.1v02b/player/player1.png")
PlayerHand(1) = _LoadImage("assets/Vantiro-1.1v02b/player/hand1.png")
PlayerSprite(2) = _LoadImage("assets/Vantiro-1.1v02b/player/player2.png")
PlayerHand(2) = _LoadImage("assets/Vantiro-1.1v02b/player/hand1.png")
PlayerSprite(3) = _LoadImage("assets/Vantiro-1.1v02b/player/player3.png")
PlayerHand(3) = _LoadImage("assets/Vantiro-1.1v02b/player/hand3.png")
PlayerSprite(4) = _LoadImage("assets/Vantiro-1.1v02b/player/player4.png")
PlayerHand(4) = _LoadImage("assets/Vantiro-1.1v02b/player/hand4.png")
BloodDrop = _LoadImage("assets/Vantiro-1.1v02b/Blooddrop.png")
Dim Shared PlayerDamage
Dim Shared PlayerDeath
PlayerDamage = _SndOpen("assets/Vantiro-1.1v02b/player/sounds/au.wav")
PlayerDeath = _SndOpen("assets/Vantiro-1.1v02b/player/sounds/ua.wav")
FlameThrowerSound = _SndOpen("assets/Vantiro-1.1v02b/sounds/interior_fire01_stereo.wav")

Dim Shared ZombieWalk(4)
ZombieWalk(1) = _SndOpen("assets/Vantiro-1.1v02b/mobs/sounds/headless_1.wav")
ZombieWalk(2) = _SndOpen("assets/Vantiro-1.1v02b/mobs/sounds/headless_2.wav")
ZombieWalk(3) = _SndOpen("assets/Vantiro-1.1v02b/mobs/sounds/headless_3.wav")
ZombieWalk(4) = _SndOpen("assets/Vantiro-1.1v02b/mobs/sounds/headless_4.wav")

Dim Shared ZombieShot(16)
ZombieShot(1) = _SndOpen("assets/Vantiro-1.1v02b/mobs/sounds/shot/been_shot_01.wav")
ZombieShot(2) = _SndOpen("assets/Vantiro-1.1v02b/mobs/sounds/shot/been_shot_02.wav")
ZombieShot(3) = _SndOpen("assets/Vantiro-1.1v02b/mobs/sounds/shot/been_shot_03.wav")
ZombieShot(4) = _SndOpen("assets/Vantiro-1.1v02b/mobs/sounds/shot/been_shot_04.wav")
ZombieShot(5) = _SndOpen("assets/Vantiro-1.1v02b/mobs/sounds/shot/been_shot_05.wav")
ZombieShot(6) = _SndOpen("assets/Vantiro-1.1v02b/mobs/sounds/shot/been_shot_06.wav")
ZombieShot(7) = _SndOpen("assets/Vantiro-1.1v02b/mobs/sounds/shot/been_shot_07.wav")
ZombieShot(8) = _SndOpen("assets/Vantiro-1.1v02b/mobs/sounds/shot/been_shot_08.wav")
ZombieShot(9) = _SndOpen("assets/Vantiro-1.1v02b/mobs/sounds/shot/been_shot_09.wav")
ZombieShot(10) = _SndOpen("assets/Vantiro-1.1v02b/mobs/sounds/shot/been_shot_10.wav")
ZombieShot(11) = _SndOpen("assets/Vantiro-1.1v02b/mobs/sounds/shot/been_shot_11.wav")
ZombieShot(12) = _SndOpen("assets/Vantiro-1.1v02b/mobs/sounds/shot/been_shot_12.wav")
ZombieShot(13) = _SndOpen("assets/Vantiro-1.1v02b/mobs/sounds/shot/been_shot_13.wav")
ZombieShot(14) = _SndOpen("assets/Vantiro-1.1v02b/mobs/sounds/shot/been_shot_14.wav")
ZombieShot(15) = _SndOpen("assets/Vantiro-1.1v02b/mobs/sounds/shot/been_shot_15.wav")
ZombieShot(16) = _SndOpen("assets/Vantiro-1.1v02b/mobs/sounds/shot/been_shot_16.wav")
...
End Type
VantiroTitulo = _LoadImage("assets/Vantiro-1.1v02b/Vantiro.png")
Background1 = _LoadImage("assets/Vantiro-1.1v02b/Background.png")
...
Tileset = _LoadImage("assets/Vantiro-1.1v02b/tileset.png")


E_KeyIcon = _LoadImage("assets/Vantiro-1.1v02b/items/ekeyicon.png")

Guns_Pistol = _LoadImage("assets/Vantiro-1.1v02b/items/pistol.png")
Guns_Shotgun = _LoadImage("assets/Vantiro-1.1v02b/items/shotgun.png")
Guns_SMG = _LoadImage("assets/Vantiro-1.1v02b/items/smg.png")
Guns_Flame = _LoadImage("assets/Vantiro-1.1v02b/items/flamethrower.png")
Guns_Grenade = _LoadImage("assets/Vantiro-1.1v02b/items/grenade.png")
HudSelected = _LoadImage("assets/Vantiro-1.1v02b/Selected.png")
HudNotSelected = _LoadImage("assets/Vantiro-1.1v02b/NotSelected.png")
HudNoAmmo = _LoadImage("assets/Vantiro-1.1v02b/NoAmmo.png")

Zombie = _LoadImage("assets/Vantiro-1.1v02b/mobs/zombie.png")
ZombieRunner = _LoadImage("assets/Vantiro-1.1v02b/mobs/fastzombie.png")
ZombieSlower = _LoadImage("assets/Vantiro-1.1v02b/mobs/slowzombie.png")
ZombieBomber = _LoadImage("assets/Vantiro-1.1v02b/mobs/bomberzombie.png")
ZombieBiohazard = _LoadImage("assets/Vantiro-1.1v02b/mobs/zombie.png") ' GIVE ME IMAGE
ZombieBrute = _LoadImage("assets/Vantiro-1.1v02b/mobs/zombie.png") 'GIVE ME IMAGE
ZombieFire = _LoadImage("assets/Vantiro-1.1v02b/mobs/firezombie.png")

ShellShotgunAmmo = _LoadImage("assets/Vantiro-1.1v02b/items/shotgunammo.png")
PistolShellAmmo = _LoadImage("assets/Vantiro-1.1v02b/items/pistolammo.png")
GasCanAmmo = _LoadImage("assets/Vantiro-1.1v02b/items/gascan.png")


Dim Shared WallShot
WallShot = _LoadImage("assets/Vantiro-1.1v02b/items/wallshot.png")
GlassShard = _LoadImage("assets/Vantiro-1.1v02b/items/glassshard.png")
Dim Shared Bloodsplat
BloodsplatGreen = _LoadImage("assets/Vantiro-1.1v02b/items/bloodsplatgreen.png")
BloodsplatRed = _LoadImage("assets/Vantiro-1.1v02b/items/bloodsplatred.png")
Gib_Skull = _LoadImage("assets/Vantiro-1.1v02b/items/skull.png")
Gib_Bone = _LoadImage("assets/Vantiro-1.1v02b/items/bone.png")
Dim Shared Bloodonground
Bloodonground = _LoadImage("assets/Vantiro-1.1v02b/items/bloodonground.png")
Guns_Sound_PistolShot = _SndOpen("assets/Vantiro-1.1v02b/sounds/pistolshot.wav")
Guns_Sound_ShotgunShot = _SndOpen("assets/Vantiro-1.1v02b/sounds/shotgunshot.wav")

Dim Shared FireParticles(3)
FireParticle = _LoadImage("assets/Vantiro-1.1v02b/items/fire1.png")
FireParticles(1) = _LoadImage("assets/Vantiro-1.1v02b/items/fire1.png")
FireParticles(2) = _LoadImage("assets/Vantiro-1.1v02b/items/fire2.png")
FireParticles(3) = _LoadImage("assets/Vantiro-1.1v02b/items/fire3.png")

Dim SMGSounds(3)
SMGSounds(1) = _SndOpen("assets/Vantiro-1.1v02b/sounds/hks1.wav")
SMGSounds(2) = _SndOpen("assets/Vantiro-1.1v02b/sounds/hks2.wav")
SMGSounds(3) = _SndOpen("assets/Vantiro-1.1v02b/sounds/hks3.wav")

Dim ShellSounds(3)
ShellSounds(1) = _SndOpen("assets/Vantiro-1.1v02b/sounds/sshell1.wav")
ShellSounds(2) = _SndOpen("assets/Vantiro-1.1v02b/sounds/sshell2.wav")
ShellSounds(3) = _SndOpen("assets/Vantiro-1.1v02b/sounds/sshell3.wav")
Dim PistolShellSounds(3)
PistolShellSounds(1) = _SndOpen("assets/Vantiro-1.1v02b/sounds/pl_shell1.wav")
PistolShellSounds(2) = _SndOpen("assets/Vantiro-1.1v02b/sounds/pl_shell2.wav")
PistolShellSounds(3) = _SndOpen("assets/Vantiro-1.1v02b/sounds/pl_shell3.wav")

Dim BloodSounds(6)
BloodSounds(1) = _SndOpen("assets/Vantiro-1.1v02b/sounds/flesh1.wav")
BloodSounds(2) = _SndOpen("assets/Vantiro-1.1v02b/sounds/flesh2.wav")
BloodSounds(3) = _SndOpen("assets/Vantiro-1.1v02b/sounds/flesh3.wav")
BloodSounds(4) = _SndOpen("assets/Vantiro-1.1v02b/sounds/flesh5.wav")
BloodSounds(5) = _SndOpen("assets/Vantiro-1.1v02b/sounds/flesh6.wav")
BloodSounds(6) = _SndOpen("assets/Vantiro-1.1v02b/sounds/flesh7.wav")
Dim Shared GlassShadder(3)
GlassShadder(1) = _SndOpen("assets/Vantiro-1.1v02b/sounds/bustglass1.wav")
GlassShadder(2) = _SndOpen("assets/Vantiro-1.1v02b/sounds/bustglass2.wav")
GlassShadder(3) = _SndOpen("assets/Vantiro-1.1v02b/sounds/bustglass3.wav")
Dim GlassSound(4)
GlassSound(1) = _SndOpen("assets/Vantiro-1.1v02b/sounds/glass1.wav")
GlassSound(2) = _SndOpen("assets/Vantiro-1.1v02b/sounds/glass2.wav")
GlassSound(3) = _SndOpen("assets/Vantiro-1.1v02b/sounds/glass3.wav")
GlassSound(4) = _SndOpen("assets/Vantiro-1.1v02b/sounds/glass4.wav")

HudImageHealth = _NewImage(128, 128, 32)
Hud_Health_Icon = _LoadImage("assets/Vantiro-1.1v02b/BloodIcon.png")
Hud_Health_Fluid = _LoadImage("assets/Vantiro-1.1v02b/BloodHealth.png")

SND_Explosion = _SndOpen("assets/Vantiro-1.1v02b/sounds/explode.mp3")
Particle_Shotgun_Shell = _LoadImage("assets/Vantiro-1.1v02b/items/shotgunshell.png")
Particle_Pistol_Shell = _LoadImage("assets/Vantiro-1.1v02b/items/pistolshell.png")
Particle_Smoke = _LoadImage("assets/Vantiro-1.1v02b/items/smoke.png")
Particle_Explosion = _LoadImage("assets/Vantiro-1.1v02b/items/explosion.png")
...
Do
    ...
    ' If Debug = 1 Then Tile(Fix(Player.x / Map.TileSize), Fix(Player.y / Map.TileSize), 1).PlayerStand = 1
    If _KeyDown(15360) And delay = 0 And Debug = 1 Then ZombieAIchoose = ZombieAIchoose + 1: delay = 20: If ZombieAIchoose = 2 Then ZombieAIchoose = 0
...
If SelectedHudID > 5 Then SelectedHudID = 5
For i = 1 To 5 'HudWeaponMax ' 6
    Hud(i).size = Config.Hud_Size
    Hud(i).yp = _Height - Hud(i).size * 1.5 + (Abs(i - SelectedHudID) * 20)
    Hud(i).xp = (_Width / 2) + (i - SelectedHudID) * Hud(i).size * 2.8

    Hud(i).x = Hud(i).x + ((Hud(i).xp - Hud(i).x) / Config.Hud_SmoothingX)
    Hud(i).y = Hud(i).y + ((Hud(i).yp - Hud(i).y) / Config.Hud_SmoothingY)
    Hud(i).x = Hud(i).x + ((SelectedHudID - LastSelectedHudID) * 20)
    Hud(i).x = Hud(i).x
    Hud(i).y = Hud(i).y
    ...
    Hud(i).xm = Hud(i).xm / Config.Hud_XMYMDivide
    Hud(i).ym = Hud(i).ym / Config.Hud_XMYMDivide

    If i = SelectedHudID Then
        Line (Hud(i).x1, Hud(i).y1)-(Hud(i).x2, Hud(i).y2), Config.Hud_SelectedColor, BF
        _MapTriangle (0, 0)-(16, 32)-(32, 0), HudSelected To(Hud(i).x1, Hud(i).y2)-(Hud(i).x, _Height)-(Hud(i).x2, Hud(i).y2)
    End If
    If i <> SelectedHudID Then
        Line (Hud(i).x1, Hud(i).y1)-(Hud(i).x2, Hud(i).y2), Config.Hud_UnSelectedColor, BF
        _MapTriangle (0, 0)-(16, 32)-(32, 0), HudNotSelected To(Hud(i).x1, Hud(i).y2)-(Hud(i).x, _Height)-(Hud(i).x2, Hud(i).y2)
    End If
...
WaveDisplayTHX = thx: WaveDisplayTHY = thy
_PutImage (_Width / 2 - WaveDisplayTHX / 2, WaveDisplayY - WaveDisplayTHY / 2), ImgToMenu
Text$ = (_Trim$(Str$(WaveBudget)) + " Infectados vindo...")
FontSizeUse = 40
GoSub HudText
WaveDisplayTHX = thx
_PutImage (_Width / 2 - WaveDisplayTHX / 2, WaveDisplayY + WaveDisplayTHY / 2), ImgToMenu
...
_Dest MainScreen
If Not _FileExists("assets/Vantiro-1.1v02b/menu/" + RTrim$(LTrim$(ToLoad$)) + ".bhmenu") Then
    Beep
    FileMissing$ = ToLoad$
    FileMissingtype$ = "Menu file"
    ToLoad$ = "warningfilemissing"
End If
Open ("assets/Vantiro-1.1v02b/menu/" + RTrim$(LTrim$(ToLoad$)) + ".bhmenu") For Input As #1
Input #1, lasti
For i = 1 To lasti
...
Function LoadMapSettings (MapName As String)
    LoadMapSettings = 0
    Open ("assets/Vantiro-1.1v02b/maps/" + MapName + ".map") For Input As #1
...
Sub LoadConfigs
    Dim trash$
    Open ("assets/Vantiro-1.1v02b/config.ini") For Input As #4
    Input #4, trash$
    ...
    'Input #4, line$: InsEqual = InStr(1, line$, "=") + 1: InsApo = InStr(1, line$, "'") - 1
    '  = Val(_Trim$((Mid$(line$, InsEqual, InsApo - InsEqual))))
...
Sub SaveConfig
    Open ("assets/Vantiro-1.1v02b/config.ini") For Output As #4
