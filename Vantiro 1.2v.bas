...
'$DYNAMIC
$RESIZE:ON
Icon = _LOADIMAGE("assets/Vantiro-1.2v/vantirologo.png")
_ICON Icon, Icon
...
PlayerSprite(1) = _LOADIMAGE("assets/Vantiro-1.2v/player/player1.png", 33)
PlayerHand(1) = _LOADIMAGE("assets/Vantiro-1.2v/player/hand1.png", 33)

PlayerSprite(2) = _LOADIMAGE("assets/Vantiro-1.2v/player/player2.png", 33)
PlayerHand(2) = _LOADIMAGE("assets/Vantiro-1.2v/player/hand1.png", 33)

PlayerSprite(3) = _LOADIMAGE("assets/Vantiro-1.2v/player/player3.png", 33)
PlayerHand(3) = _LOADIMAGE("assets/Vantiro-1.2v/player/hand3.png", 33)

PlayerSprite(4) = _LOADIMAGE("assets/Vantiro-1.2v/player/player4.png", 33)
PlayerHand(4) = _LOADIMAGE("assets/Vantiro-1.2v/player/hand4.png", 33)

BloodDrop = _LOADIMAGE("assets/Vantiro-1.2v/Blooddrop.png")

DIM SHARED PlayerDamage
DIM SHARED PlayerDeath
PlayerDamage = _SNDOPEN("assets/Vantiro-1.2v/player/sounds/au.wav")
PlayerDeath = _SNDOPEN("assets/Vantiro-1.2v/player/sounds/ua.wav")
FlameThrowerSound = _SNDOPEN("assets/Vantiro-1.2v/sounds/interior_fire01_stereo.wav")

DIM SHARED ZombieWalk(4)
ZombieWalk(1) = _SNDOPEN("assets/Vantiro-1.2v/mobs/sounds/headless_1.wav")
ZombieWalk(2) = _SNDOPEN("assets/Vantiro-1.2v/mobs/sounds/headless_2.wav")
ZombieWalk(3) = _SNDOPEN("assets/Vantiro-1.2v/mobs/sounds/headless_3.wav")
ZombieWalk(4) = _SNDOPEN("assets/Vantiro-1.2v/mobs/sounds/headless_4.wav")

DIM SHARED ZombieShot(16)
ZombieShot(1) = _SNDOPEN("assets/Vantiro-1.2v/mobs/sounds/shot/been_shot_01.wav")
ZombieShot(2) = _SNDOPEN("assets/Vantiro-1.2v/mobs/sounds/shot/been_shot_02.wav")
ZombieShot(3) = _SNDOPEN("assets/Vantiro-1.2v/mobs/sounds/shot/been_shot_03.wav")
ZombieShot(4) = _SNDOPEN("assets/Vantiro-1.2v/mobs/sounds/shot/been_shot_04.wav")
ZombieShot(5) = _SNDOPEN("assets/Vantiro-1.2v/mobs/sounds/shot/been_shot_05.wav")
ZombieShot(6) = _SNDOPEN("assets/Vantiro-1.2v/mobs/sounds/shot/been_shot_06.wav")
ZombieShot(7) = _SNDOPEN("assets/Vantiro-1.2v/mobs/sounds/shot/been_shot_07.wav")
ZombieShot(8) = _SNDOPEN("assets/Vantiro-1.2v/mobs/sounds/shot/been_shot_08.wav")
ZombieShot(9) = _SNDOPEN("assets/Vantiro-1.2v/mobs/sounds/shot/been_shot_09.wav")
ZombieShot(10) = _SNDOPEN("assets/Vantiro-1.2v/mobs/sounds/shot/been_shot_10.wav")
ZombieShot(11) = _SNDOPEN("assets/Vantiro-1.2v/mobs/sounds/shot/been_shot_11.wav")
ZombieShot(12) = _SNDOPEN("assets/Vantiro-1.2v/mobs/sounds/shot/been_shot_12.wav")
ZombieShot(13) = _SNDOPEN("assets/Vantiro-1.2v/mobs/sounds/shot/been_shot_13.wav")
ZombieShot(14) = _SNDOPEN("assets/Vantiro-1.2v/mobs/sounds/shot/been_shot_14.wav")
ZombieShot(15) = _SNDOPEN("assets/Vantiro-1.2v/mobs/sounds/shot/been_shot_15.wav")
ZombieShot(16) = _SNDOPEN("assets/Vantiro-1.2v/mobs/sounds/shot/been_shot_16.wav")
...
END TYPE
VantiroTitulo = _LOADIMAGE("assets/Vantiro-1.2v/Vantiro.png", 33)
Background1 = _LOADIMAGE("assets/Vantiro-1.2v/Background.png", 33)
DIM SHARED Hud(9) AS Hud
DIM SHARED Minimap AS Hud
TXTGlint = _LOADIMAGE("assets/begs world/textures/glint.png", 33)
DIM SHARED MenuMax
MenuMax = 65
...
DIM SHARED Tileset
DIM SHARED TilesetSoft

TilesetSoft = _LOADIMAGE("assets/Vantiro-1.2v/tileset.png")
Tileset = _LOADIMAGE("assets/Vantiro-1.2v/tileset.png", 33)


E_KeyIcon = _LOADIMAGE("assets/Vantiro-1.2v/items/EKeyIcon.png", 33)

Guns_Pistol = _LOADIMAGE("assets/Vantiro-1.2v/items/pistol.png", 33)
Guns_Shotgun = _LOADIMAGE("assets/Vantiro-1.2v/items/shotgun.png", 33)
Guns_SMG = _LOADIMAGE("assets/Vantiro-1.2v/items/smg.png", 33)
Guns_Flame = _LOADIMAGE("assets/Vantiro-1.2v/items/flamethrower.png", 33)
Guns_Grenade = _LOADIMAGE("assets/Vantiro-1.2v/items/grenade.png", 33)
HudSelected = _LOADIMAGE("assets/Vantiro-1.2v/Selected.png", 33)
HudNotSelected = _LOADIMAGE("assets/Vantiro-1.2v/NotSelected.png", 33)
HudNoAmmo = _LOADIMAGE("assets/Vantiro-1.2v/NoAmmo.png", 33)

Zombie = _LOADIMAGE("assets/Vantiro-1.2v/mobs/zombie.png", 33)
ZombieRunner = _LOADIMAGE("assets/Vantiro-1.2v/mobs/fastzombie.png", 33)
ZombieSlower = _LOADIMAGE("assets/Vantiro-1.2v/mobs/slowzombie.png", 33)
ZombieBomber = _LOADIMAGE("assets/Vantiro-1.2v/mobs/bomberzombie.png", 33)
ZombieBiohazard = _LOADIMAGE("assets/Vantiro-1.2v/mobs/zombie.png", 33) ' GIVE ME IMAGE
ZombieBrute = _LOADIMAGE("assets/Vantiro-1.2v/mobs/zombie.png", 33) 'GIVE ME IMAGE
ZombieFire = _LOADIMAGE("assets/Vantiro-1.2v/mobs/firezombie.png", 33)

ShellShotgunAmmo = _LOADIMAGE("assets/Vantiro-1.2v/items/shotgunammo.png", 33)
PistolShellAmmo = _LOADIMAGE("assets/Vantiro-1.2v/items/pistolammo.png", 33)
GasCanAmmo = _LOADIMAGE("assets/Vantiro-1.2v/items/gascan.png", 33)


DIM SHARED WallShot
WallShot = _LOADIMAGE("assets/Vantiro-1.2v/items/wallshot.png", 33)
GlassShard = _LOADIMAGE("assets/Vantiro-1.2v/items/glassshard.png", 33)
DIM SHARED Bloodsplat
BloodsplatGreen = _LOADIMAGE("assets/Vantiro-1.2v/items/bloodsplatgreen.png", 33)
BloodsplatRed = _LOADIMAGE("assets/Vantiro-1.2v/items/bloodsplatred.png", 33)
Gib_Skull = _LOADIMAGE("assets/Vantiro-1.2v/items/skull.png", 33)
Gib_Bone = _LOADIMAGE("assets/Vantiro-1.2v/items/bone.png", 33)
DIM SHARED Bloodonground
Bloodonground = _LOADIMAGE("assets/Vantiro-1.2v/items/bloodonground.png", 33)
Guns_Sound_PistolShot = _SNDOPEN("assets/Vantiro-1.2v/sounds/pistolshot.wav")
Guns_Sound_ShotgunShot = _SNDOPEN("assets/Vantiro-1.2v/sounds/shotgunshot.wav")

'FireParticles(firechoosen)
DIM SHARED FireParticles(3)
DIM SHARED FireParticlesSoft(3)
FireParticle = _LOADIMAGE("assets/Vantiro-1.2v/items/fire1.png", 33)
FireParticles(1) = _LOADIMAGE("assets/Vantiro-1.2v/items/fire1.png", 33)
FireParticles(2) = _LOADIMAGE("assets/Vantiro-1.2v/items/fire2.png", 33)
FireParticles(3) = _LOADIMAGE("assets/Vantiro-1.2v/items/fire3.png", 33)

FireParticlesSoft(1) = _LOADIMAGE("assets/Vantiro-1.2v/items/fire1.png", 32)
FireParticlesSoft(2) = _LOADIMAGE("assets/Vantiro-1.2v/items/fire2.png", 32)
FireParticlesSoft(3) = _LOADIMAGE("assets/Vantiro-1.2v/items/fire3.png", 32)


DIM SMGSounds(3)
SMGSounds(1) = _SNDOPEN("assets/Vantiro-1.2v/sounds/hks1.wav")
SMGSounds(2) = _SNDOPEN("assets/Vantiro-1.2v/sounds/hks2.wav")
SMGSounds(3) = _SNDOPEN("assets/Vantiro-1.2v/sounds/hks3.wav")

DIM ShellSounds(3)
ShellSounds(1) = _SNDOPEN("assets/Vantiro-1.2v/sounds/sshell1.wav")
ShellSounds(2) = _SNDOPEN("assets/Vantiro-1.2v/sounds/sshell2.wav")
ShellSounds(3) = _SNDOPEN("assets/Vantiro-1.2v/sounds/sshell3.wav")
DIM PistolShellSounds(3)
PistolShellSounds(1) = _SNDOPEN("assets/Vantiro-1.2v/sounds/pl_shell1.wav")
PistolShellSounds(2) = _SNDOPEN("assets/Vantiro-1.2v/sounds/pl_shell2.wav")
PistolShellSounds(3) = _SNDOPEN("assets/Vantiro-1.2v/sounds/pl_shell3.wav")

DIM BloodSounds(6)
BloodSounds(1) = _SNDOPEN("assets/Vantiro-1.2v/sounds/flesh1.wav")
BloodSounds(2) = _SNDOPEN("assets/Vantiro-1.2v/sounds/flesh2.wav")
BloodSounds(3) = _SNDOPEN("assets/Vantiro-1.2v/sounds/flesh3.wav")
BloodSounds(4) = _SNDOPEN("assets/Vantiro-1.2v/sounds/flesh5.wav")
BloodSounds(5) = _SNDOPEN("assets/Vantiro-1.2v/sounds/flesh6.wav")
BloodSounds(6) = _SNDOPEN("assets/Vantiro-1.2v/sounds/flesh7.wav")
DIM SHARED GlassShadder(3)
GlassShadder(1) = _SNDOPEN("assets/Vantiro-1.2v/sounds/bustglass1.wav")
GlassShadder(2) = _SNDOPEN("assets/Vantiro-1.2v/sounds/bustglass2.wav")
GlassShadder(3) = _SNDOPEN("assets/Vantiro-1.2v/sounds/bustglass3.wav")
DIM GlassSound(4)
GlassSound(1) = _SNDOPEN("assets/Vantiro-1.2v/sounds/glass1.wav")
GlassSound(2) = _SNDOPEN("assets/Vantiro-1.2v/sounds/glass2.wav")
GlassSound(3) = _SNDOPEN("assets/Vantiro-1.2v/sounds/glass3.wav")
GlassSound(4) = _SNDOPEN("assets/Vantiro-1.2v/sounds/glass4.wav")

HudImageHealth = _NEWIMAGE(128, 128, 32)
Hud_Health_Icon = _LOADIMAGE("assets/Vantiro-1.2v/BloodIcon.png")
Hud_Health_Fluid = _LOADIMAGE("assets/Vantiro-1.2v/BloodHealth.png")

SND_Explosion = _SNDOPEN("assets/Vantiro-1.2v/sounds/explode.mp3")
Particle_Shotgun_Shell = _LOADIMAGE("assets/Vantiro-1.2v/items/shotgunshell.png", 33)
Particle_Pistol_Shell = _LOADIMAGE("assets/Vantiro-1.2v/items/pistolshell.png", 33)
Particle_Smoke = _LOADIMAGE("assets/Vantiro-1.2v/items/smoke.png", 33)
Particle_Explosion = _LOADIMAGE("assets/Vantiro-1.2v/items/explosion.png", 33)
...
DIM SHARED LightLevel(256) AS LONG
DIM SHARED TempImg AS LONG
FOR i = 0 TO 256
   TempImg = _NEWIMAGE(2, 2, 32)
   _DEST TempImg
   CLS , 0
   LINE (0, 0)-(2, 2), _RGBA32(0, 0, 0, i), BF
   LightLevel(i) = _COPYIMAGE(TempImg, 33)
   _FREEIMAGE TempImg
...
DO
   ...
   LOOP
   PlayerInteract = 0
   IF PlayerInteract = 0 AND (_KEYDOWN(101) + _KEYDOWN(69)) = -1 AND PlayerInteractPre = 0 THEN PlayerInteract = 1
   PlayerInteractPre = _KEYDOWN(101) + _KEYDOWN(69)
   ...
   IF _KEYDOWN(106) AND delay = 0 AND debug = 1 THEN
      ...
      NEXT
   END IF
   IF Player(1).Health > 101 THEN Player(1).Health = Player(1).Health - 1
   ...
   IF Lig < 1 THEN Lig = 1
   _PUTIMAGE (0, 0)-(_WIDTH, _HEIGHT), LightLevel(Lig)
   GOSUB Fire
...
PRINT "GAME IS NOW PAUSED, PRESS SPACE TO CONTINUE."
_DISPLAY
DO
   _KEYCLEAR
...
IF PlayerIsOnFire > 0 THEN firechoosen = (INT(RND * 3) + 1): _PUTIMAGE (0, 0)-(_WIDTH, _HEIGHT), FireParticlesSoft(firechoosen)
...
FOR x = 0 TO Map.MaxWidth
   FOR y = 0 TO Map.MaxHeight
      ...
      xs = x * MinimapTxtSize
      ys = y * MinimapTxtSize
      IF Tile(x, y, z).ID <> 0 THEN _PUTIMAGE (xs, ys)-(xs + (MinimapTxtSize), ys + (MinimapTxtSize)), TilesetSoft, MinimapIMG, (Tile(x, y, z).rend_spritex * Map.TextureSize, Tile(x, y, z).rend_spritey * Map.TextureSize)-(Tile(x, y, z).rend_spritex * Map.TextureSize + (Map.TextureSize - 1), Tile(x, y, z).rend_spritey * Map.TextureSize + (Map.TextureSize - 1))
...
FOR i = 1 TO FireMax
   IF Fire(i).visible > 0 THEN
      ...
      Fire(i).xm = Fire(i).xm / 1.015
      Fire(i).ym = Fire(i).ym / 1.015
      ...
      IF Fire(i).txt = 0 THEN
         ...
         NEXT
      END IF
      IF INT(RND * 13) <= 4 THEN Fire(i).visible = Fire(i).visible - 1
      IF Fire(i).visible > 5 AND Fire(i).txt <> 4 AND Distance(Fire(i).x, Fire(i).y, Player(1).x, Player(1).y) < INT(Size * 1.2) THEN PlayerIsOnFire = 5 * Fire(i).visible
      IF Fire(i).visible > 15 AND FIX(Fire(i).visible / 1.5) > 5 AND INT(RND * 10) = 3 THEN
         FireLast = FireLast + 1: IF FireLast > FireMax THEN FireLast = 1
         Fire(FireLast).txt = Fire(i).txt
         Fire(i).visible = Fire(i).visible - 8
         Fire(FireLast).froozen = FIX(Fire(i).visible * 2)
         Fire(FireLast).visible = 4
         Fire(FireLast).x = Fire(i).x + (INT(RND * 30) - 15) * 4
         Fire(FireLast).y = Fire(i).y + (INT(RND * 30) - 15) * 4
         FOR k = 1 TO FireMax
            IF k <> i THEN
   ...
   IF TriggerPlayerCollide(Player(1), Trigger(i)) THEN
      ...
      SELECT CASE Trigger(i).class
         ...
         CASE "DoorUse"
            ...
            _PUTIMAGE (ETSX((DoorX * Map.TileSize) + (Map.TileSize / 3.5)), ETSY((DoorY * Map.TileSize) + (Map.TileSize / 3.5)))-(ETSX(((DoorX + 1) * Map.TileSize) - (Map.TileSize / 3.5)), ETSY(((DoorY + 1) * Map.TileSize) - (Map.TileSize / 3.5))), E_KeyIcon
...
IF INT(RND * 6) + 1 = 3 AND DeathTimer < 200 THEN SpawnBloodParticle Player(1).x - 20 + INT(RND * 21), Player(1).y - 20 + INT(RND * 21), -180 + INT(RND * 361), 20, "red": Part(LastPart).xm = INT(RND * 500) - 250: Part(LastPart).ym = INT(RND * 500) - 250: Part(LastPart).zm = INT(Part(LastPart).zm / 4)
...
RANDOMIZE TIMER
IF WaveWait = 0 THEN
   WaveWait = 600: WaveDisplayY = -thy: Wave = Wave + 1
   IF Wave < 2 THEN
      WaveBudget = (Wave * 5) + INT(RND * 8)
   ELSE
      WaveBudget = (Wave * 8) + INT(RND * 30)

   END IF
   IF WaveBudget > 128 THEN WaveBudget = 128
END IF
IF Wave = 9 THEN WaveWait = -9999999: DelayUntilStart = 2000: Showtext = 1: WaveDisplayY = -thy * 2: GOTO EndWaveCode
IF WaveWait = 1 THEN
   DayAmount = DayAmount - 1
      ...
      IF Special = 1 THEN
         ...
         SELECT CASE SpecialType
            ...
            CASE 4 ' Bomber
               ...
               Zombie(i).knockback = INT(RND * 20) + 10
            ...
            CASE 6 ' Biohazard
               Rand = INT(RND * 200)
               Zombie(i).size = INT(RND * (37 - 27 + 1)) + 35
               Zombie(i).health = INT(RND * (INT(DefZombie.maxhealth) - FIX(DefZombie.minhealth) + 1)) + FIX(DefZombie.minhealth)
               Zombie(i).maxspeed = INT(RND * (850 - 500 + 1)) + 500
               Zombie(i).damage = INT(RND * (10 - 2 + 1)) + 2
               Zombie(i).speeding = INT(RND * (10 - 5 + 1)) + 5
...
WaveDisplayTHX = thx: WaveDisplayTHY = thy
_PUTIMAGE (_WIDTH / 2 - WaveDisplayTHX / 2, WaveDisplayY - WaveDisplayTHY / 2), ImgToMenu
Text$ = (_TRIM$(STR$(WaveBudget)) + " Infected coming...")
FontSizeUse = 40
GOSUB HudText
WaveDisplayTHX = thx
_PUTIMAGE (_WIDTH / 2 - WaveDisplayTHX / 2, WaveDisplayY + WaveDisplayTHY / 2), ImgToMenu
...
FOR i = 2 TO 6
   ...
   IF HideUI = 0 THEN
      ...
      IF i = HighestHud THEN _PUTIMAGE (Hud(i).x1, Hud(i).y2)-(Hud(i).x2, Hud(i).y1), HudSelected
      IF i <> HighestHud THEN _PUTIMAGE (Hud(i).x1, Hud(i).y2)-(Hud(i).x2, Hud(i).y1), HudNotSelected
...
FOR i = 1 TO GrenadeMax
   ...
   IF Grenade(i).froozen = -1 THEN
      ...
      Grenade(i).visible = 0
      Grenade(i).froozen = 0
      Explosion Grenade(i).x, Grenade(i).y, 130, 450
   ...
   IF Zombie(i).active = 1 THEN
      IF Zombie(i).special <> "" AND Zombie(i).DistanceFromPlayer < 900 THEN
         ...
         IF Zombie(i).special = "Fire" THEN
            IF Zombie(i).DistanceFromPlayer < 400 AND INT(RND * 10) = 4 THEN
               FireLast = FireLast + 1: IF FireLast > FireMax THEN FireLast = 1
               ...
               Fire(FireLast).txt = 1: speed = (50 + INT(RND * 120))
            ...
            IF INT(RND * 40) = 23 THEN
               ...
               IF Distance(Fire(FireLast).x, Fire(FireLast).y, Player(1).x, Player(1).y) > 80 THEN
                  ...
                  IF INT(RND * 100) = 54 THEN
                     Fire(FireLast).froozen = 100 + INT(RND * 70): Fire(FireLast).visible = 15
         ...
         IF Zombie(i).special = "Bomber" THEN
            IF Zombie(i).DistanceFromPlayer < 600 AND Zombie(i).DistanceFromPlayer > 6 THEN
               ...
               END IF
               IF Zombie(i).SpecialDelay > 120 THEN
                  Zombie(i).size = Zombie(i).size * 1.08: IF Zombie(i).size > 120 THEN Zombie(i).size = 120
      ...
      IF Zombie(i).special <> "Fire" THEN
         IF Zombie(i).onfire > 0 THEN
            ...
            IF INT(RND * 150) < 10 THEN
               Zombie(i).health = Zombie(i).health - 1
               IF INT(RND * 250) < 20 THEN
                  FireLast = FireLast + 1: IF FireLast > FireMax THEN FireLast = 1
                  Fire(FireLast).visible = 6
                  Fire(FireLast).froozen = 15
                  Fire(FireLast).txt = 0
                  Fire(FireLast).x = Zombie(i).x + (INT(RND * 30) - 15)
                  Fire(FireLast).y = Zombie(i).y + (INT(RND * 30) - 15)
                  Fire(FireLast).xm = (Zombie(i).xm / 10) + (INT(RND * 30) - 15)
                  Fire(FireLast).ym = (Zombie(i).ym / 10) + (INT(RND * 30) - 15)
               END IF
            END IF
         END IF
      END IF
      ...
      IF Zombie(i).DamageTaken > 0 THEN
         FOR S = 1 TO INT(Zombie(i).DamageTaken / 2)
      ...
      IF Zombie(i).DistanceFromPlayer < 1700 THEN

         IF CollisionWithWallsEntity(Zombie(i)) THEN
         END IF
      END IF
      IF Zombie(i).tick = 0 THEN
         IF INT(RND * 80) = 27 AND Zombie(i).DistanceFromPlayer < 800 THEN _SNDPLAYCOPY ZombieWalk(INT(RND * 4) + 1), 0.08
      ...
      IF Zombie(i).health <= 0 THEN
         ...
         IF Zombie(i).special = "Fire" AND INT(RND * 4) + 1 = 2 THEN SpawnBloodParticle Zombie(i).x, Zombie(i).y, INT(RND * 360) - 180, 5, "GasAmmo"
         ...
         IF Zombie(i).special = "Bomber" THEN
            ...
            FOR b = 1 TO 50
               SpawnBloodParticle Zombie(i).x, Zombie(i).y, Zombie(i).rotation + INT(RND * 90) - 40, INT(RND * 70), "green"
            NEXT
         END IF
         ...
         NEXT
      END IF
      IF Zombie(i).x < Map.TileSize THEN
         Zombie(i).x = 2 * Map.TileSize
      END IF
      IF Zombie(i).y < Map.TileSize THEN
         Zombie(i).y = 2 * Map.TileSize
      END IF
      IF Zombie(i).x > 127 * Map.TileSize THEN
         Zombie(i).x = 126 * Map.TileSize
      END IF
      IF Zombie(i).y > 127 * Map.TileSize THEN
         Zombie(i).y = 126 * Map.TileSize
      END IF
...
FOR i = 1 TO ParticlesMax
   ...
   IF Part(i).playwhatsound = "Blood" AND Part(i).froozen = 0 THEN
      ...
      IF dist > 1300 THEN Part(i).visible = Part(i).visible - 1
      IF dist < 1300 AND Player(1).Health > 0 THEN
         ...
         IF dist < 30 AND Part(i).partid = "BloodSplat" THEN
            ...
            BloodPart(LastBloodPart).ym = 80 + INT(RND * 50)
            BloodPart(LastBloodPart).visible = 1
            Part(i).visible = 0: Part(i).xm = 0: Part(i).ym = 0: Part(i).playwhatsound = "": Player(1).Health = Player(1).Health + 0.15: GOTO EndOfParticleLogic
         END IF
         ...
         IF dist < 25 AND Part(i).partid = "ShotgunAmmo" THEN ShotgunAmmo = ShotgunAmmo + 6: Part(i).playwhatsound = "": Part(i).visible = 0: Part(i).xm = 0: Part(i).ym = 0: GOTO EndOfParticleLogic
         IF dist < 25 AND Part(i).partid = "GasAmmo" THEN FlameAmmo = FlameAmmo + 20: Part(i).playwhatsound = "": Part(i).visible = 0: Part(i).xm = 0: Part(i).ym = 0: GOTO EndOfParticleLogic
         ...
         Part(i).xm = Part(i).xm / 1.02
         Part(i).ym = Part(i).ym / 1.02
...
IF Mouse.click AND ShootDelay = 0 AND PlayerCantMove = 0 THEN
   ...
   IF GunDisplay(1).wtype = 1 THEN
      _SNDPLAYCOPY Guns_Sound_PistolShot, 0.25: IF raycasting(GunDisplay(1).x, GunDisplay(1).y, GunDisplay(1).rotation + (INT(RND * 3) - 1), 14, 1) THEN BEEP
      LINE (ETSX(GunDisplay(1).x), ETSY(GunDisplay(1).y))-(ETSX(Ray.x), ETSY(Ray.y)), _RGB32(255, 0, 0)
      ShootDelay = 14: GunForce = 20
...
FOR i = 1 TO 2
   ...
   IF moving = 0 THEN PlayerMember(i).speed = 0.5 + Distance(PlayerMember(i).x, PlayerMember(i).y, PlayerMember(i).xbe, PlayerMember(i).ybe) / 20
   IF moving > 0 THEN
...
IF Mouse.click2 THEN
   ...
   CameraXM = CameraXM + (SIN(GunDisplay(1).rotation * PIDIV180) * (15 + (AimingTime / 20)))
   CameraYM = CameraYM + (-COS(GunDisplay(1).rotation * PIDIV180) * (15 + (AimingTime / 20)))
   Player(1).xm = INT(Player(1).xm / 1.08)
   Player(1).ym = INT(Player(1).ym / 1.08)
ELSE
   AimingTime = 0
END IF
...
IF PlayerIsOnFire > 0 THEN
   ...
   IF INT(RND * 6) = 2 THEN
      ...
      Fire(FireLast).txt = 4
      Fire(FireLast).xm = (-Player(1).xm) + (INT(RND * 30) - 15) * 4
      Fire(FireLast).ym = (-Player(1).ym) + (INT(RND * 30) - 15) * 4
   END IF
END IF
...
IF Player(1).TouchX = 0 THEN
   IF _KEYDOWN(100) OR _KEYDOWN(68) THEN Player(1).xm = Player(1).xm - 3: movingx = 1: IF ismoving = 0 THEN moving = moving + 1: ismoving = 1
   IF _KEYDOWN(97) OR _KEYDOWN(65) THEN Player(1).xm = Player(1).xm + 3: movingx = 1: IF ismoving = 0 THEN moving = moving + 1: ismoving = 1
END IF
IF Player(1).TouchY = 0 THEN
   IF _KEYDOWN(119) OR _KEYDOWN(87) THEN Player(1).ym = Player(1).ym + 3: movingy = 1: IF ismoving = 0 THEN moving = moving + 1: ismoving = 1
   IF _KEYDOWN(115) OR _KEYDOWN(83) THEN Player(1).ym = Player(1).ym - 3: movingy = 1: IF ismoving = 0 THEN moving = moving + 1: ismoving = 1
END IF
...
FOR P = 1 TO PlayerLimit
   IF debug = 1 THEN LINE (ETSX(Player(P).x1), ETSY(Player(P).y1))-(ETSX(Player(P).x2), ETSY(Player(P).y2)), _RGBA32(P * 120, 255, 255, 32), BF
...
_DEST MainScreen
IF NOT _FILEEXISTS("assets/Vantiro-1.2v/menu/" + RTRIM$(LTRIM$(ToLoad$)) + ".bhmenu") THEN
   BEEP
   FileMissing$ = ToLoad$
   FileMissingtype$ = "Menu file"
   ToLoad$ = "warningfilemissing"
END IF
OPEN ("assets/Vantiro-1.2v/menu/" + RTRIM$(LTRIM$(ToLoad$)) + ".bhmenu") FOR INPUT AS #1
INPUT #1, lasti
FOR i = 1 TO lasti
...
SUB SpawnBloodParticle (x AS DOUBLE, y AS DOUBLE, angle AS DOUBLE, Steps AS LONG, BloodType AS STRING)
   ...
   IF BloodType = "green" THEN Part(LastPart).froozen = -15
...
FUNCTION CollisionWithWallsEntity (Player AS Entity)
   ...
   IF Tile(FIX(Player.x / Map.TileSize), FIX(Player.y / Map.TileSize), 2).solid = 1 THEN Player.x = Player.x + 16
...
FUNCTION LoadMapSettings (MapName AS STRING)
   LoadMapSettings = 0
   OPEN ("assets/Vantiro-1.2v/maps/" + MapName + ".map") FOR INPUT AS #1
