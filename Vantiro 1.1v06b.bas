...
'$Dynamic
$Resize:On
Icon = _LoadImage("assets/Vantiro-1.1v06b/vantirologo.png", 32)
_Icon Icon, Icon
_Title "Vantiro"
...
Dim line$
If _FileExists("assets/Vantiro-1.1v06b/config.ini") Then
    LoadConfigs
Else
    Beep
    Print "Error: (assets/Vantiro-1.1v06b/config.ini) not found, generating file."
    _Display
    _Delay 2
    SaveConfig
End If
...
PlayerSprite(1) = _LoadImage("assets/Vantiro-1.1v06b/player/player1.png", 33)
PlayerHand(1) = _LoadImage("assets/Vantiro-1.1v06b/player/hand1.png", 33)
PlayerSprite(2) = _LoadImage("assets/Vantiro-1.1v06b/player/player2.png", 33)
PlayerHand(2) = _LoadImage("assets/Vantiro-1.1v06b/player/hand1.png", 33)
PlayerSprite(3) = _LoadImage("assets/Vantiro-1.1v06b/player/player3.png", 33)
PlayerHand(3) = _LoadImage("assets/Vantiro-1.1v06b/player/hand3.png", 33)
PlayerSprite(4) = _LoadImage("assets/Vantiro-1.1v06b/player/player4.png", 33)
PlayerHand(4) = _LoadImage("assets/Vantiro-1.1v06b/player/hand4.png", 33)
BloodDrop = _LoadImage("assets/Vantiro-1.1v06b/Blooddrop.png", 32)
Dim Shared PlayerDamage
Dim Shared PlayerDeath
PlayerDamage = _SndOpen("assets/Vantiro-1.1v06b/player/sounds/au.wav")
PlayerDeath = _SndOpen("assets/Vantiro-1.1v06b/player/sounds/ua.wav")
FlameThrowerSound = _SndOpen("assets/Vantiro-1.1v06b/sounds/interior_fire01_stereo.wav")

Dim Shared ZombieWalk(4)
ZombieWalk(1) = _SndOpen("assets/Vantiro-1.1v06b/mobs/sounds/headless_1.wav")
ZombieWalk(2) = _SndOpen("assets/Vantiro-1.1v06b/mobs/sounds/headless_2.wav")
ZombieWalk(3) = _SndOpen("assets/Vantiro-1.1v06b/mobs/sounds/headless_3.wav")
ZombieWalk(4) = _SndOpen("assets/Vantiro-1.1v06b/mobs/sounds/headless_4.wav")

Dim Shared ZombieShot(16)
ZombieShot(1) = _SndOpen("assets/Vantiro-1.1v06b/mobs/sounds/shot/been_shot_01.wav")
ZombieShot(2) = _SndOpen("assets/Vantiro-1.1v06b/mobs/sounds/shot/been_shot_02.wav")
ZombieShot(3) = _SndOpen("assets/Vantiro-1.1v06b/mobs/sounds/shot/been_shot_03.wav")
ZombieShot(4) = _SndOpen("assets/Vantiro-1.1v06b/mobs/sounds/shot/been_shot_04.wav")
ZombieShot(5) = _SndOpen("assets/Vantiro-1.1v06b/mobs/sounds/shot/been_shot_05.wav")
ZombieShot(6) = _SndOpen("assets/Vantiro-1.1v06b/mobs/sounds/shot/been_shot_06.wav")
ZombieShot(7) = _SndOpen("assets/Vantiro-1.1v06b/mobs/sounds/shot/been_shot_07.wav")
ZombieShot(8) = _SndOpen("assets/Vantiro-1.1v06b/mobs/sounds/shot/been_shot_08.wav")
ZombieShot(9) = _SndOpen("assets/Vantiro-1.1v06b/mobs/sounds/shot/been_shot_09.wav")
ZombieShot(10) = _SndOpen("assets/Vantiro-1.1v06b/mobs/sounds/shot/been_shot_10.wav")
ZombieShot(11) = _SndOpen("assets/Vantiro-1.1v06b/mobs/sounds/shot/been_shot_11.wav")
ZombieShot(12) = _SndOpen("assets/Vantiro-1.1v06b/mobs/sounds/shot/been_shot_12.wav")
ZombieShot(13) = _SndOpen("assets/Vantiro-1.1v06b/mobs/sounds/shot/been_shot_13.wav")
ZombieShot(14) = _SndOpen("assets/Vantiro-1.1v06b/mobs/sounds/shot/been_shot_14.wav")
ZombieShot(15) = _SndOpen("assets/Vantiro-1.1v06b/mobs/sounds/shot/been_shot_15.wav")
ZombieShot(16) = _SndOpen("assets/Vantiro-1.1v06b/mobs/sounds/shot/been_shot_16.wav")
...
missing = _LoadImage("assets/Vantiro-1.1v06b/missing.png", 33)
VantiroTitulo = _LoadImage("assets/Vantiro-1.1v06b/Vantiro.png", 33)
Background1 = _LoadImage("assets/Vantiro-1.1v06b/Background.png", 33)
HudWeaponMax = 16
...
Tileset = _LoadImage("assets/Vantiro-1.1v06b/" + _Trim$(Map.tileset) + ".png", 33)
TilesetSoft = _LoadImage("assets/Vantiro-1.1v06b/" + _Trim$(Map.tileset) + ".png", 32)


E_KeyIcon = _LoadImage("assets/Vantiro-1.1v06b/items/ekeyicon.png", 33)

Guns_Hammer = _LoadImage("assets/Vantiro-1.1v06b/items/hammer.png", 33)
Guns_Pistol = _LoadImage("assets/Vantiro-1.1v06b/items/pistol.png", 33)
Guns_Shotgun = _LoadImage("assets/Vantiro-1.1v06b/items/shotgun.png", 33)
Guns_SMG = _LoadImage("assets/Vantiro-1.1v06b/items/smg.png", 33)
Guns_Flame = _LoadImage("assets/Vantiro-1.1v06b/items/flamethrower.png", 33)
Guns_Grenade = _LoadImage("assets/Vantiro-1.1v06b/items/grenade.png", 33)
Guns_Chainsaw = CreateImageText(Guns_Chainsaw, "Chainsaw", 25)
HudSelected = _LoadImage("assets/Vantiro-1.1v06b/Selected.png", 33)
HudNotSelected = _LoadImage("assets/Vantiro-1.1v06b/NotSelected.png", 33)
HudNoAmmo = _LoadImage("assets/Vantiro-1.1v06b/NoAmmo.png", 33)

Zombie = _LoadImage("assets/Vantiro-1.1v06b/mobs/zombie.png", 33)
ZombieRunner = _LoadImage("assets/Vantiro-1.1v06b/mobs/fastzombie.png", 33)
ZombieSlower = _LoadImage("assets/Vantiro-1.1v06b/mobs/slowzombie.png", 33)
ZombieBomber = _LoadImage("assets/Vantiro-1.1v06b/mobs/bomberzombie.png", 33)
ZombieBiohazard = _LoadImage("assets/Vantiro-1.1v06b/mobs/zombie.png", 33) ' GIVE ME IMAGE
ZombieBrute = _LoadImage("assets/Vantiro-1.1v06b/mobs/zombie.png", 33) 'GIVE ME IMAGE
ZombieFire = _LoadImage("assets/Vantiro-1.1v06b/mobs/firezombie.png", 33)
...
ShellShotgunAmmo = _LoadImage("assets/Vantiro-1.1v06b/items/shotgunammo.png", 33)
PistolShellAmmo = _LoadImage("assets/Vantiro-1.1v06b/items/pistolammo.png", 33)
GasCanAmmo = _LoadImage("assets/Vantiro-1.1v06b/items/gascan.png", 33)


Dim Shared WallShot
WallShot = _LoadImage("assets/Vantiro-1.1v06b/items/wallshot.png", 33)
GlassShard = _LoadImage("assets/Vantiro-1.1v06b/items/glassshard.png", 33)
Dim Shared Bloodsplat
BloodsplatGreen = _LoadImage("assets/Vantiro-1.1v06b/items/bloodsplatgreen.png", 33)
BloodsplatRed = _LoadImage("assets/Vantiro-1.1v06b/items/bloodsplatred.png", 33)
Gib_Skull = _LoadImage("assets/Vantiro-1.1v06b/items/skull.png", 33)
Gib_Bone = _LoadImage("assets/Vantiro-1.1v06b/items/bone.png", 33)
Dim Shared Bloodonground
Bloodonground = _LoadImage("assets/Vantiro-1.1v06b/items/bloodonground.png", 32)
Guns_Sound_PistolShot = _SndOpen("assets/Vantiro-1.1v06b/sounds/pistolshot.wav")
Guns_Sound_ShotgunShot = _SndOpen("assets/Vantiro-1.1v06b/sounds/shotgunshot.wav")


Dim Shared FireParticles(3)
FireParticle = _LoadImage("assets/Vantiro-1.1v06b/items/fire1.png", 33)
FireParticles(1) = _LoadImage("assets/Vantiro-1.1v06b/items/fire1.png", 33)
FireParticles(2) = _LoadImage("assets/Vantiro-1.1v06b/items/fire2.png", 33)
FireParticles(3) = _LoadImage("assets/Vantiro-1.1v06b/items/fire3.png", 33)

Dim SMGSounds(3)
SMGSounds(1) = _SndOpen("assets/Vantiro-1.1v06b/sounds/hks1.wav")
SMGSounds(2) = _SndOpen("assets/Vantiro-1.1v06b/sounds/hks2.wav")
SMGSounds(3) = _SndOpen("assets/Vantiro-1.1v06b/sounds/hks3.wav")

Dim ShellSounds(3)
ShellSounds(1) = _SndOpen("assets/Vantiro-1.1v06b/sounds/sshell1.wav")
ShellSounds(2) = _SndOpen("assets/Vantiro-1.1v06b/sounds/sshell2.wav")
ShellSounds(3) = _SndOpen("assets/Vantiro-1.1v06b/sounds/sshell3.wav")
Dim PistolShellSounds(3)
PistolShellSounds(1) = _SndOpen("assets/Vantiro-1.1v06b/sounds/pl_shell1.wav")
PistolShellSounds(2) = _SndOpen("assets/Vantiro-1.1v06b/sounds/pl_shell2.wav")
PistolShellSounds(3) = _SndOpen("assets/Vantiro-1.1v06b/sounds/pl_shell3.wav")

Dim BloodSounds(6)
BloodSounds(1) = _SndOpen("assets/Vantiro-1.1v06b/sounds/flesh1.wav")
BloodSounds(2) = _SndOpen("assets/Vantiro-1.1v06b/sounds/flesh2.wav")
BloodSounds(3) = _SndOpen("assets/Vantiro-1.1v06b/sounds/flesh3.wav")
BloodSounds(4) = _SndOpen("assets/Vantiro-1.1v06b/sounds/flesh5.wav")
BloodSounds(5) = _SndOpen("assets/Vantiro-1.1v06b/sounds/flesh6.wav")
BloodSounds(6) = _SndOpen("assets/Vantiro-1.1v06b/sounds/flesh7.wav")
Dim Shared GlassShadder(3)
GlassShadder(1) = _SndOpen("assets/Vantiro-1.1v06b/sounds/bustglass1.wav")
GlassShadder(2) = _SndOpen("assets/Vantiro-1.1v06b/sounds/bustglass2.wav")
GlassShadder(3) = _SndOpen("assets/Vantiro-1.1v06b/sounds/bustglass3.wav")
Dim GlassSound(4)
GlassSound(1) = _SndOpen("assets/Vantiro-1.1v06b/sounds/glass1.wav")
GlassSound(2) = _SndOpen("assets/Vantiro-1.1v06b/sounds/glass2.wav")
GlassSound(3) = _SndOpen("assets/Vantiro-1.1v06b/sounds/glass3.wav")
GlassSound(4) = _SndOpen("assets/Vantiro-1.1v06b/sounds/glass4.wav")

HudImageHealth = _NewImage(128, 128, 32)
Hud_Health_Icon = _LoadImage("assets/Vantiro-1.1v06b/BloodIcon.png", 32)
Hud_Health_Fluid = _LoadImage("assets/Vantiro-1.1v06b/BloodHealth.png", 32)

SND_Explosion = _SndOpen("assets/Vantiro-1.1v06b/sounds/explode.mp3")
Particle_Shotgun_Shell = _LoadImage("assets/Vantiro-1.1v06b/items/shotgunshell.png", 33)
Particle_Pistol_Shell = _LoadImage("assets/Vantiro-1.1v06b/items/pistolshell.png", 33)
Particle_Smoke = _LoadImage("assets/Vantiro-1.1v06b/items/smoke.png", 33)
Particle_Explosion = _LoadImage("assets/Vantiro-1.1v06b/items/explosion.png", 33)
    ...
    For x = 0 To Map.MaxWidth
        For y = 0 To Map.MaxHeight
            ...
            Select Case Tile(x, y, z).ID
                Case 5
                    StaticLight(1).x = x * Map.TileSize + (Map.TileSize / 2)
                    StaticLight(1).y = y * Map.TileSize + (Map.TileSize / 2)
...
If _KeyDown(16384) And delay = 0 Then ' " ' " key, saves waypoints.
    delay = 30
    Open ("assets/Vantiro-1.1v06b/maps/" + Map$ + ".waypoints") For Output As #3
...
If _KeyDown(16640) And delay = 0 Then ' " ' " key, saves waypoints.
    delay = 30
    Open ("assets/Vantiro-1.1v06b/maps/" + Map$ + ".waypoints") For Input As #3
...
For x = rendcamerax1 To rendcamerax2 'Map.MaxWidth
    For y = rendcameray1 To rendcameray2 'Map.MaxHeight
        ...
        _PutImage (XCalc, YCalc)-(XCalc + Map.TileSize, YCalc + Map.TileSize), Shadowgradient, 0, (light / (Tile(x, y, 0).toplayer / 2), 0)-(light / (Tile(x, y, 0).toplayer / 2), 1)
    Next
Next
...
For i = 1 To FireMax
    If Fire(i).visible > 0 Then
        If Fire(i).visible > 10 Then CreateDynamicLight Fire(i).x, Fire(i).y, Fire(i).visible * 3, 2, "Low"
...
For i = 1 To 1
    ...
    If GunDisplay.visible = 1 Then
        ...
        If Player.shooting = 1 Then
            CreateDynamicLight GunDisplay.x + GunSin * 80, GunDisplay.y + GunCos * 80, 250, 4, "High"
...
LoadAllMaps:
Dim findfile As String: findfile = _Files$("assets/Vantiro-1.1v06b/maps/*.map")
i = 0
ImagesFound = 0
Do While Len(findfile) > 0
    ...
    If _FileExists("assets/Vantiro-1.1v06b/maps/" + ImageAlternative$) Then
        ...
        MapLoaderImage(ImagesFound) = _LoadImage("assets/Vantiro-1.1v06b/maps/" + ImageAlternative$)
...
_Dest MainScreen
If Not _FileExists("assets/Vantiro-1.1v06b/menu/" + RTrim$(LTrim$(ToLoad$)) + ".bhmenu") Then
    Beep
    FileMissing$ = ToLoad$
    FileMissingtype$ = "Menu file"
    ToLoad$ = "warningfilemissing"
End If
Open ("assets/Vantiro-1.1v06b/menu/" + RTrim$(LTrim$(ToLoad$)) + ".bhmenu") For Input As #1
Input #1, lasti
For i = 1 To lasti
...
Function ShadowView (x As Double, y As Double, x2 As Double, y2 As Double, hitbox As Double, stepsize As Double, tolerance As Integer)
    ShadowView = 0
...
Function LoadMapSettings (MapName As String)
    LoadMapSettings = 0
    Open ("assets/Vantiro-1.1v06b/maps/" + MapName + ".map") For Input As #1
...
Sub LoadConfigs
    Dim trash$
    Open ("assets/Vantiro-1.1v06b/config.ini") For Input As #4
    Input #4, version
    Input #4, trash$
...
Sub SaveConfig
    Open ("assets/Vantiro-1.1v06b/config.ini") For Output As #4
        ...
        For w = 1 To WaypointMax
            If Waypoint(w).free = -1 Then
                ...
                If Distance(Waypoint(w).x, Waypoint(w).y, Zombie.x, Zombie.y) < Map.TileSize * 10 Then
                    ...
                    '_Display
                    '_Delay 0.06
                    If IsInView(Zombie.x, Zombie.y, Waypoint(w).x, Waypoint(w).y, Map.TileSize / 2, 15, 0) = -1 Then
                        '    Print "IN VIEW!"
                        '    _Display
                        '    _Delay 1
                        dist = Distance(Waypoint(w).x, Waypoint(w).y, Zombie.x, Zombie.y)
...
Sub CalcLightingDynLow (Light As LightSource)
    ...
    For x = xmin To xmax
        For y = ymin To ymax
            dist = Int(Distance((x * Map.TileSize) + (Map.TileSize / 2), (y * Map.TileSize) + (Map.TileSize / 2), Light.x, Light.y)) - (Light.strength + (Int(Rnd * 8) - 4))
...
Sub CalcLightingDynNormal (Light As LightSource)
    ...
    For x = xmin To xmax
        For y = ymin To ymax
            ...
            Isview = ShadowView(Light.x - 9, Light.y, (x * Map.TileSize) + (Map.TileSize / 2) + 8, (y * Map.TileSize) + (Map.TileSize / 2), Map.TileSize / 2, 15, 70)
...
Sub CalcLightingDynHigh (Light As LightSource)
    ...
    For x = xmin To xmax
        For y = ymin To ymax
            ...
            Isview = ShadowView(Light.x - 7, Light.y, (x * Map.TileSize) + (Map.TileSize / 2) + 8, (y * Map.TileSize) + (Map.TileSize / 2), Map.TileSize / 2, 15, 70)
            If Isview <> -1 Then newlight = (newlight - (Isview * 15))
...
Sub CalcLightingStatic (Light As LightSource)
    ...
    For x = xmin To xmax
        For y = ymin To ymax
            ...
            newlight = ((Light.strength + (Int(Rnd * 8) - 4)) - dist)
            If newlight > 255 Then newlight = 255
            Isview = ShadowView(Light.x - 5, Light.y, (x * Map.TileSize) + (Map.TileSize / 2) + 5, (y * Map.TileSize) + (Map.TileSize / 2), Map.TileSize / 4, 3, 100)
            If Isview <> -1 Then newlight = (newlight - (Isview * 4))
...
Sub CreateDynamicLight (x As Double, y As Double, strength As Integer, duration As Integer, detail As String)
