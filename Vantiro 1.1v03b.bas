...
'$Dynamic
$Resize:On
Icon = _LoadImage("assets/Vantiro-1.1v03b/vantirologo.png")
_Icon Icon, Icon
_Title "Vantiro"
...
'# Hud settings.
Config.Hud_SmoothingY = 7 ' (Def: 7)
Config.Hud_SmoothingX = 10 ' (Def: 10)
Config.Hud_Size = 32 ' (Def: 32)
Config.Hud_XMYMDivide = 1.1 ' (Def: 1.1)
...
Dim line$
If _FileExists("assets/Vantiro-1.1v03b/config.ini") Then
    LoadConfigs
Else
    Beep
    Print "Error: (assets/Vantiro-1.1v03b/config.ini) not found, generating file."
    _Display
    _Delay 2
    SaveConfig
End If
...
PlayerSprite(1) = _LoadImage("assets/Vantiro-1.1v03b/player/player1.png")
PlayerHand(1) = _LoadImage("assets/Vantiro-1.1v03b/player/hand1.png")
PlayerSprite(2) = _LoadImage("assets/Vantiro-1.1v03b/player/player2.png")
PlayerHand(2) = _LoadImage("assets/Vantiro-1.1v03b/player/hand1.png")
PlayerSprite(3) = _LoadImage("assets/Vantiro-1.1v03b/player/player3.png")
PlayerHand(3) = _LoadImage("assets/Vantiro-1.1v03b/player/hand3.png")
PlayerSprite(4) = _LoadImage("assets/Vantiro-1.1v03b/player/player4.png")
PlayerHand(4) = _LoadImage("assets/Vantiro-1.1v03b/player/hand4.png")
BloodDrop = _LoadImage("assets/Vantiro-1.1v03b/Blooddrop.png")
Dim Shared PlayerDamage
Dim Shared PlayerDeath
PlayerDamage = _SndOpen("assets/Vantiro-1.1v03b/player/sounds/au.wav")
PlayerDeath = _SndOpen("assets/Vantiro-1.1v03b/player/sounds/ua.wav")
FlameThrowerSound = _SndOpen("assets/Vantiro-1.1v03b/sounds/interior_fire01_stereo.wav")

Dim Shared ZombieWalk(4)
ZombieWalk(1) = _SndOpen("assets/Vantiro-1.1v03b/mobs/sounds/headless_1.wav")
ZombieWalk(2) = _SndOpen("assets/Vantiro-1.1v03b/mobs/sounds/headless_2.wav")
ZombieWalk(3) = _SndOpen("assets/Vantiro-1.1v03b/mobs/sounds/headless_3.wav")
ZombieWalk(4) = _SndOpen("assets/Vantiro-1.1v03b/mobs/sounds/headless_4.wav")

Dim Shared ZombieShot(16)
ZombieShot(1) = _SndOpen("assets/Vantiro-1.1v03b/mobs/sounds/shot/been_shot_01.wav")
ZombieShot(2) = _SndOpen("assets/Vantiro-1.1v03b/mobs/sounds/shot/been_shot_02.wav")
ZombieShot(3) = _SndOpen("assets/Vantiro-1.1v03b/mobs/sounds/shot/been_shot_03.wav")
ZombieShot(4) = _SndOpen("assets/Vantiro-1.1v03b/mobs/sounds/shot/been_shot_04.wav")
ZombieShot(5) = _SndOpen("assets/Vantiro-1.1v03b/mobs/sounds/shot/been_shot_05.wav")
ZombieShot(6) = _SndOpen("assets/Vantiro-1.1v03b/mobs/sounds/shot/been_shot_06.wav")
ZombieShot(7) = _SndOpen("assets/Vantiro-1.1v03b/mobs/sounds/shot/been_shot_07.wav")
ZombieShot(8) = _SndOpen("assets/Vantiro-1.1v03b/mobs/sounds/shot/been_shot_08.wav")
ZombieShot(9) = _SndOpen("assets/Vantiro-1.1v03b/mobs/sounds/shot/been_shot_09.wav")
ZombieShot(10) = _SndOpen("assets/Vantiro-1.1v03b/mobs/sounds/shot/been_shot_10.wav")
ZombieShot(11) = _SndOpen("assets/Vantiro-1.1v03b/mobs/sounds/shot/been_shot_11.wav")
ZombieShot(12) = _SndOpen("assets/Vantiro-1.1v03b/mobs/sounds/shot/been_shot_12.wav")
ZombieShot(13) = _SndOpen("assets/Vantiro-1.1v03b/mobs/sounds/shot/been_shot_13.wav")
ZombieShot(14) = _SndOpen("assets/Vantiro-1.1v03b/mobs/sounds/shot/been_shot_14.wav")
ZombieShot(15) = _SndOpen("assets/Vantiro-1.1v03b/mobs/sounds/shot/been_shot_15.wav")
ZombieShot(16) = _SndOpen("assets/Vantiro-1.1v03b/mobs/sounds/shot/been_shot_16.wav")
...
VantiroTitulo = _LoadImage("assets/Vantiro-1.1v03b/Vantiro.png")
Background1 = _LoadImage("assets/Vantiro-1.1v03b/Background.png")
HudWeaponMax = 16
...
Tileset = _LoadImage("assets/Vantiro-1.1v03b/tileset.png")


E_KeyIcon = _LoadImage("assets/Vantiro-1.1v03b/items/ekeyicon.png")

Guns_Hammer = _LoadImage("assets/Vantiro-1.1v03b/items/hammer.png")
Guns_Pistol = _LoadImage("assets/Vantiro-1.1v03b/items/pistol.png")
Guns_Shotgun = _LoadImage("assets/Vantiro-1.1v03b/items/shotgun.png")
Guns_SMG = _LoadImage("assets/Vantiro-1.1v03b/items/smg.png")
Guns_Flame = _LoadImage("assets/Vantiro-1.1v03b/items/flamethrower.png")
Guns_Grenade = _LoadImage("assets/Vantiro-1.1v03b/items/grenade.png")
HudSelected = _LoadImage("assets/Vantiro-1.1v03b/Selected.png")
HudNotSelected = _LoadImage("assets/Vantiro-1.1v03b/NotSelected.png")
HudNoAmmo = _LoadImage("assets/Vantiro-1.1v03b/NoAmmo.png")

Zombie = _LoadImage("assets/Vantiro-1.1v03b/mobs/zombie.png")
ZombieRunner = _LoadImage("assets/Vantiro-1.1v03b/mobs/fastzombie.png")
ZombieSlower = _LoadImage("assets/Vantiro-1.1v03b/mobs/slowzombie.png")
ZombieBomber = _LoadImage("assets/Vantiro-1.1v03b/mobs/bomberzombie.png")
ZombieBiohazard = _LoadImage("assets/Vantiro-1.1v03b/mobs/zombie.png") ' GIVE ME IMAGE
ZombieBrute = _LoadImage("assets/Vantiro-1.1v03b/mobs/zombie.png") 'GIVE ME IMAGE
ZombieFire = _LoadImage("assets/Vantiro-1.1v03b/mobs/firezombie.png")
...
ShellShotgunAmmo = _LoadImage("assets/Vantiro-1.1v03b/items/shotgunammo.png")
PistolShellAmmo = _LoadImage("assets/Vantiro-1.1v03b/items/pistolammo.png")
GasCanAmmo = _LoadImage("assets/Vantiro-1.1v03b/items/gascan.png")


Dim Shared WallShot
WallShot = _LoadImage("assets/Vantiro-1.1v03b/items/wallshot.png")
GlassShard = _LoadImage("assets/Vantiro-1.1v03b/items/glassshard.png")
Dim Shared Bloodsplat
BloodsplatGreen = _LoadImage("assets/Vantiro-1.1v03b/items/bloodsplatgreen.png")
BloodsplatRed = _LoadImage("assets/Vantiro-1.1v03b/items/bloodsplatred.png")
Gib_Skull = _LoadImage("assets/Vantiro-1.1v03b/items/skull.png")
Gib_Bone = _LoadImage("assets/Vantiro-1.1v03b/items/bone.png")
Dim Shared Bloodonground
Bloodonground = _LoadImage("assets/Vantiro-1.1v03b/items/bloodonground.png")
Guns_Sound_PistolShot = _SndOpen("assets/Vantiro-1.1v03b/sounds/pistolshot.wav")
Guns_Sound_ShotgunShot = _SndOpen("assets/Vantiro-1.1v03b/sounds/shotgunshot.wav")

Dim Shared FireParticles(3)
FireParticle = _LoadImage("assets/Vantiro-1.1v03b/items/fire1.png")
FireParticles(1) = _LoadImage("assets/Vantiro-1.1v03b/items/fire1.png")
FireParticles(2) = _LoadImage("assets/Vantiro-1.1v03b/items/fire2.png")
FireParticles(3) = _LoadImage("assets/Vantiro-1.1v03b/items/fire3.png")

Dim SMGSounds(3)
SMGSounds(1) = _SndOpen("assets/Vantiro-1.1v03b/sounds/hks1.wav")
SMGSounds(2) = _SndOpen("assets/Vantiro-1.1v03b/sounds/hks2.wav")
SMGSounds(3) = _SndOpen("assets/Vantiro-1.1v03b/sounds/hks3.wav")

Dim ShellSounds(3)
ShellSounds(1) = _SndOpen("assets/Vantiro-1.1v03b/sounds/sshell1.wav")
ShellSounds(2) = _SndOpen("assets/Vantiro-1.1v03b/sounds/sshell2.wav")
ShellSounds(3) = _SndOpen("assets/Vantiro-1.1v03b/sounds/sshell3.wav")
Dim PistolShellSounds(3)
PistolShellSounds(1) = _SndOpen("assets/Vantiro-1.1v03b/sounds/pl_shell1.wav")
PistolShellSounds(2) = _SndOpen("assets/Vantiro-1.1v03b/sounds/pl_shell2.wav")
PistolShellSounds(3) = _SndOpen("assets/Vantiro-1.1v03b/sounds/pl_shell3.wav")

Dim BloodSounds(6)
BloodSounds(1) = _SndOpen("assets/Vantiro-1.1v03b/sounds/flesh1.wav")
BloodSounds(2) = _SndOpen("assets/Vantiro-1.1v03b/sounds/flesh2.wav")
BloodSounds(3) = _SndOpen("assets/Vantiro-1.1v03b/sounds/flesh3.wav")
BloodSounds(4) = _SndOpen("assets/Vantiro-1.1v03b/sounds/flesh5.wav")
BloodSounds(5) = _SndOpen("assets/Vantiro-1.1v03b/sounds/flesh6.wav")
BloodSounds(6) = _SndOpen("assets/Vantiro-1.1v03b/sounds/flesh7.wav")
Dim Shared GlassShadder(3)
GlassShadder(1) = _SndOpen("assets/Vantiro-1.1v03b/sounds/bustglass1.wav")
GlassShadder(2) = _SndOpen("assets/Vantiro-1.1v03b/sounds/bustglass2.wav")
GlassShadder(3) = _SndOpen("assets/Vantiro-1.1v03b/sounds/bustglass3.wav")
Dim GlassSound(4)
GlassSound(1) = _SndOpen("assets/Vantiro-1.1v03b/sounds/glass1.wav")
GlassSound(2) = _SndOpen("assets/Vantiro-1.1v03b/sounds/glass2.wav")
GlassSound(3) = _SndOpen("assets/Vantiro-1.1v03b/sounds/glass3.wav")
GlassSound(4) = _SndOpen("assets/Vantiro-1.1v03b/sounds/glass4.wav")

HudImageHealth = _NewImage(128, 128, 32)
Hud_Health_Icon = _LoadImage("assets/Vantiro-1.1v03b/BloodIcon.png")
Hud_Health_Fluid = _LoadImage("assets/Vantiro-1.1v03b/BloodHealth.png")

SND_Explosion = _SndOpen("assets/Vantiro-1.1v03b/sounds/explode.mp3")
Particle_Shotgun_Shell = _LoadImage("assets/Vantiro-1.1v03b/items/shotgunshell.png")
Particle_Pistol_Shell = _LoadImage("assets/Vantiro-1.1v03b/items/pistolshell.png")
Particle_Smoke = _LoadImage("assets/Vantiro-1.1v03b/items/smoke.png")
Particle_Explosion = _LoadImage("assets/Vantiro-1.1v03b/items/explosion.png")
...
If SelectedHudID = 6 Then
    ...
    If BlockMenuToggle = 1 Then
        ...
        LastSelectedTextureHudID = SelectedTextureHudID
        NoSwitchHud = 1
        If Mouse.scroll <> 0 And delay = 0 Then
            SelectedTextureHudID = SelectedTextureHudID + Mouse.scroll
            delay = 3
        End If
        If SelectedTextureHudID < 1 Then SelectedTextureHudID = 1
        If SelectedTextureHudID > 7 Then SelectedTextureHudID = 7
        ...
        If Player.shooting = 1 And ShootDelay = 0 Then
            ...
            For z = 1 To ZombieMax
                If Zombie(z).active = 0 Then
                    ...
                    Select Case SelectedTextureHudID
                        Case 1 ' Normal
                            Rand = Int(Rnd * 40)
                            If Rand = 25 Then
        ...
        For i = 1 To 7
            HudLogic Hud2(i), 0, i, SelectedTextureHudID, LastSelectedTextureHudID
            Hud2(i).y1 = Hud2(i).y1 - (HudDown / 1.6): Hud2(i).y2 = Hud2(i).y2 - (HudDown / 1.6)

            If i = SelectedTextureHudID Then
            ...
            If i <> SelectedTextureHudID Then
                ...
                If i < SelectedTextureHudID And Hud2(i).y2 < _Height Then _MapTriangle (0, 0)-(16, 32)-(32, 0), HudNotSelected To(Hud2(i).x1, Hud2(i).y2)-(Hud(SelectedHudID).x1, (Hud(SelectedHudID).y1 + Hud(SelectedHudID).size / 2))-(Hud2(i).x2, Hud2(i).y2)
                If i > SelectedTextureHudID And Hud2(i).y2 < _Height Then _MapTriangle (0, 0)-(16, 32)-(32, 0), HudNotSelected To(Hud2(i).x1, Hud2(i).y2)-(Hud(SelectedHudID).x2, (Hud(SelectedHudID).y1 + Hud(SelectedHudID).size / 2))-(Hud2(i).x2, Hud2(i).y2)
            End If
            If i = 5 Then
...
For i = 1 To HudWeaponMax ' 6
    ...
    HudLogic Hud(i), HudDown, i, SelectedHudID, LastSelectedHudID

    If i = SelectedHudID Then
        Line (Hud(i).x1, Hud(i).y1)-(Hud(i).x2, Hud(i).y2), Config.Hud_SelectedColor, BF
        If Hud(i).y2 < _Height And Hud(i).y1 > 0 Then _MapTriangle (0, 0)-(16, 32)-(32, 0), HudSelected To(Hud(i).x1, Hud(i).y2)-(Hud(i).x, _Height)-(Hud(i).x2, Hud(i).y2)
    End If
    If i <> SelectedHudID Then
        Line (Hud(i).x1, Hud(i).y1)-(Hud(i).x2, Hud(i).y2), Config.Hud_UnSelectedColor, BF
        If Hud(i).y2 < _Height And Hud(i).y1 > 0 Then _MapTriangle (0, 0)-(16, 32)-(32, 0), HudNotSelected To(Hud(i).x1, Hud(i).y2)-(Hud(i).x, _Height)-(Hud(i).x2, Hud(i).y2)
    End If
...
For i = 1 To 1
    ...
    If GunDisplay.visible = 1 Then
        ...
        If Player.shooting = 1 Then
            ...
            End If
            Hud(SelectedHudID).xm = Hud(SelectedHudID).xm - Int(Sin(GunDisplay.rotation * PIDIV180) * GunForce) / 2
            Hud(SelectedHudID).ym = Hud(SelectedHudID).ym - Int(-Cos(GunDisplay.rotation * PIDIV180) * GunForce) / 2
            HudAllXm = HudAllXm - Int(Sin(GunDisplay.rotation * PIDIV180) * GunForce) / 2
            HudAllYm = HudAllYm - Int(-Cos(GunDisplay.rotation * PIDIV180) * GunForce) / 2
...
LoadAllMaps:
Dim findfile As String: findfile = _Files$("assets/Vantiro-1.1v03b/maps/*.map")
i = 0
ImagesFound = 0
Do While Len(findfile) > 0
    ...
    If _FileExists("assets/Vantiro-1.1v03b/maps/" + ImageAlternative$) Then
        ...
        MapLoaderImage(ImagesFound) = _LoadImage("assets/Vantiro-1.1v03b/maps/" + ImageAlternative$)
...
_Dest MainScreen
If Not _FileExists("assets/Vantiro-1.1v03b/menu/" + RTrim$(LTrim$(ToLoad$)) + ".bhmenu") Then
    Beep
    FileMissing$ = ToLoad$
    FileMissingtype$ = "Menu file"
    ToLoad$ = "warningfilemissing"
End If
Open ("assets/Vantiro-1.1v03b/menu/" + RTrim$(LTrim$(ToLoad$)) + ".bhmenu") For Input As #1
Input #1, lasti
For i = 1 To lasti
...
Function LoadMapSettings (MapName As String)
    LoadMapSettings = 0
    Open ("assets/Vantiro-1.1v03b/maps/" + MapName + ".map") For Input As #1
...
Sub LoadConfigs
    Dim trash$
    Open ("assets/Vantiro-1.1v03b/config.ini") For Input As #4
    Input #4, trash$
...
Sub SaveConfig
    Open ("assets/Vantiro-1.1v03b/config.ini") For Output As #4
    Print #4, "'# Hud settings."
    Print #4, "Config.Hud_SmoothingY = " + _Trim$(Str$(Config.Hud_SmoothingY)) + " ' (Def: 5)"
    Print #4, "Config.Hud_SmoothingX = " + _Trim$(Str$(Config.Hud_SmoothingX)) + " ' (Def: 5)"
    Print #4, "Config.Hud_Size = " + _Trim$(Str$(Config.Hud_Size)) + " ' (Def: 32)"
    Print #4, "Config.Hud_XMYMDivide = " + _Trim$(Str$(Config.Hud_XMYMDivide)) + " ' (Def: 1.1)"
    Print #4, "Config.Hud_SelectedColor = " + _Trim$(Str$(Config.Hud_SelectedColor)) + " ' (Def: 4294967295)"
    Print #4, "Config.Hud_UnSelectedColor = " + _Trim$(Str$(Config.Hud_UnSelectedColor)) + " ' (Def: 4286611584)"
    ...
    Print #4, "Config.FireMax = " + _Trim$(Str$(Config.FireMax)) + " ' (Def: 80)"
...
Sub HudLogic (Hud As Hud, HudDown As Double, i As Integer, Selected As Integer, LastSelected As Integer)
    Hud.size = Config.Hud_Size
    Hud.yp = _Height - Hud.size * 1.8 + ((Abs(i - Selected) ^ 5) * 2)
    Hud.xp = (_Width / 2) + (i - Selected) * Hud.size * 2.8

    Hud.x = Hud.x + ((Hud.xp - Hud.x) / Config.Hud_SmoothingX)
    Hud.y = Hud.y + ((Hud.yp - Hud.y) / Config.Hud_SmoothingY)
    '  Hud.x = Hud.x - ((Selected - LastSelected) * (Config.Hud_Size / 1.5))
    If Hud.y > _Height + (Hud.size * 4) Then Hud.y = _Height + (Hud.size * 4)
